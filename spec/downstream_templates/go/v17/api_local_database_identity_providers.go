...
func (r ApiIdentityProvidersPostRequest) Execute() (map[string]interface{}, *_nethttp.Response, error) {
...
*/
func (a *LocalDatabaseIdentityProvidersApiService) IdentityProvidersPost(ctx _context.Context) ApiIdentityProvidersPostRequest {
	return ApiIdentityProvidersPostRequest{
		ApiService: a,
		ctx:        ctx,
	}
...
// Execute executes the request
//  @return map[string]interface{}
func (a *LocalDatabaseIdentityProvidersApiService) IdentityProvidersPostExecute(r ApiIdentityProvidersPostRequest) (map[string]interface{}, *_nethttp.Response, error) {
	var (
		localVarHTTPMethod   = _nethttp.MethodPost
		localVarPostBody     interface{}
		localVarFormFileName string
...
func (r ApiIdentityProvidersTestPostRequest) Execute() (InlineResponse20015, *_nethttp.Response, error) {
...
*/
func (a *LocalDatabaseIdentityProvidersApiService) IdentityProvidersTestPost(ctx _context.Context) ApiIdentityProvidersTestPostRequest {
	return ApiIdentityProvidersTestPostRequest{
		ApiService: a,
		ctx:        ctx,
	}
...
func (a *LocalDatabaseIdentityProvidersApiService) IdentityProvidersTestPostExecute(r ApiIdentityProvidersTestPostRequest) (InlineResponse20015, *_nethttp.Response, error) {
	var (
		localVarHTTPMethod   = _nethttp.MethodPost
		localVarPostBody     interface{}
		localVarFormFileName string
