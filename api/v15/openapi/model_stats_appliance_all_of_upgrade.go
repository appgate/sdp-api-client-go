...
// NewStatsApplianceAllOfUpgrade instantiates a new StatsApplianceAllOfUpgrade object
// This constructor will assign default values to properties that have it defined,
// and makes sure properties required by API are set, but the set of arguments
// will change when the set of required properties is changed
func NewStatsApplianceAllOfUpgrade() *StatsApplianceAllOfUpgrade {
	this := StatsApplianceAllOfUpgrade{}
	return &this
}

// NewStatsApplianceAllOfUpgradeWithDefaults instantiates a new StatsApplianceAllOfUpgrade object
...
type NullableStatsApplianceAllOfUpgrade struct {
	value *StatsApplianceAllOfUpgrade
	isSet bool
}

func (v NullableStatsApplianceAllOfUpgrade) Get() *StatsApplianceAllOfUpgrade {
	return v.value
}

func (v *NullableStatsApplianceAllOfUpgrade) Set(val *StatsApplianceAllOfUpgrade) {
	v.value = val
	v.isSet = true
}

func (v NullableStatsApplianceAllOfUpgrade) IsSet() bool {
	return v.isSet
}

func (v *NullableStatsApplianceAllOfUpgrade) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableStatsApplianceAllOfUpgrade(val *StatsApplianceAllOfUpgrade) *NullableStatsApplianceAllOfUpgrade {
	return &NullableStatsApplianceAllOfUpgrade{value: val, isSet: true}
}
