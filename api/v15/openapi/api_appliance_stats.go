...
func (r ApiStatsAppliancesGetRequest) Execute() (StatsAppliance, *_nethttp.Response, error) {
 ...
 * @return StatsAppliance
 */
func (a *ApplianceStatsApiService) StatsAppliancesGetExecute(r ApiStatsAppliancesGetRequest) (StatsAppliance, *_nethttp.Response, error) {
	var (
		...
		localVarReturnValue  StatsAppliance
	)

	localBasePath, err := a.client.cfg.ServerURLWithContext(r.ctx, "ApplianceStatsApiService.StatsAppliancesGet")
	if err != nil {
