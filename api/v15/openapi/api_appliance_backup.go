 ...
 * Download a completed Appliance Backup with the given ID of an Appliance. This API call must be made with **Accept** header of **application/vnd.appgate.peer-v15+gpg** as it returns a GPG file as blob instead of JSON.
 * @param ctx _context.Context - for authentication, logging, cancellation, deadlines, tracing, etc. Passed from http.Request or context.Background().
 * @param id ID of the object.
 * @param backupId The Appliance Backup ID given in the initiation response.
