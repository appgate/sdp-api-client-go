...
func (r ApiMfaProvidersTestPostRequest) Execute() (InlineResponse2005, *_nethttp.Response, error) {
 ...
 */
func (a *MFAProvidersApiService) MfaProvidersTestPostExecute(r ApiMfaProvidersTestPostRequest) (InlineResponse2005, *_nethttp.Response, error) {
	var (
		localVarHTTPMethod   = _nethttp.MethodPost
		localVarPostBody     interface{}
		localVarFormFileName string
