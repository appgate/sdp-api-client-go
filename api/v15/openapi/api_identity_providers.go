...
func (r ApiIdentityProvidersIdAttributesPostRequest) InlineObject3(inlineObject3 InlineObject3) ApiIdentityProvidersIdAttributesPostRequest {
	r.inlineObject3 = &inlineObject3
	return r
}

func (r ApiIdentityProvidersIdAttributesPostRequest) Execute() (InlineResponse2006, *_nethttp.Response, error) {
 ...
 */
func (a *IdentityProvidersApiService) IdentityProvidersIdAttributesPostExecute(r ApiIdentityProvidersIdAttributesPostRequest) (InlineResponse2006, *_nethttp.Response, error) {
	var (
...
func (r ApiIdentityProvidersTestPostRequest) Execute() (InlineResponse2005, *_nethttp.Response, error) {
 ...
 */
func (a *IdentityProvidersApiService) IdentityProvidersTestPostExecute(r ApiIdentityProvidersTestPostRequest) (InlineResponse2005, *_nethttp.Response, error) {
	var (
		localVarHTTPMethod   = _nethttp.MethodPost
		localVarPostBody     interface{}
		localVarFormFileName string
