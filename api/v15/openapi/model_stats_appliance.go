...
// NewStatsAppliance instantiates a new StatsAppliance object
...
// NewStatsApplianceWithDefaults instantiates a new StatsAppliance object
...
func (o *StatsAppliance) GetData() []StatsApplianceAllOfData {
	if o == nil || o.Data == nil {
		var ret []StatsApplianceAllOfData
		return ret
	}
	return *o.Data
}
...
type NullableStatsAppliance struct {
	value *StatsAppliance
	isSet bool
}

func (v NullableStatsAppliance) Get() *StatsAppliance {
	return v.value
}

func (v *NullableStatsAppliance) Set(val *StatsAppliance) {
	v.value = val
	v.isSet = true
}
...
func NewNullableStatsAppliance(val *StatsAppliance) *NullableStatsAppliance {
	return &NullableStatsAppliance{value: val, isSet: true}
}
