...
// NewApplianceAllOfPortalExternalProfiles instantiates a new ApplianceAllOfPortalExternalProfiles object
...
func NewApplianceAllOfPortalExternalProfiles() *ApplianceAllOfPortalExternalProfiles {
	this := ApplianceAllOfPortalExternalProfiles{}
	return &this
}

// NewApplianceAllOfPortalExternalProfilesWithDefaults instantiates a new ApplianceAllOfPortalExternalProfiles object
...
func (o *ApplianceAllOfPortalExternalProfiles) GetId() string {
	if o == nil || o.Id == nil {
		var ret string
		return ret
	}
...
func (o *ApplianceAllOfPortalExternalProfiles) GetIdOk() (*string, bool) {
	if o == nil || o.Id == nil {
		return nil, false
	}
	return o.Id, true
...
func (o *ApplianceAllOfPortalExternalProfiles) HasId() bool {
	if o != nil && o.Id != nil {
		return true
	}
...
func (o *ApplianceAllOfPortalExternalProfiles) SetId(v string) {
	o.Id = &v
}

// GetUrl returns the Url field value if set, zero value otherwise.
func (o *ApplianceAllOfPortalExternalProfiles) GetUrl() string {
	if o == nil || o.Url == nil {
		var ret string
		return ret
	}
...
// and a boolean to check if the value has been set.
func (o *ApplianceAllOfPortalExternalProfiles) GetUrlOk() (*string, bool) {
	if o == nil || o.Url == nil {
		return nil, false
	}
	return o.Url, true
...
func (o *ApplianceAllOfPortalExternalProfiles) HasUrl() bool {
	if o != nil && o.Url != nil {
		return true
	}
...
func (o *ApplianceAllOfPortalExternalProfiles) SetUrl(v string) {
	o.Url = &v
}

// GetHostname returns the Hostname field value if set, zero value otherwise.
func (o *ApplianceAllOfPortalExternalProfiles) GetHostname() string {
...
type NullableApplianceAllOfPortalExternalProfiles struct {
	value *ApplianceAllOfPortalExternalProfiles
	isSet bool
}

func (v NullableApplianceAllOfPortalExternalProfiles) Get() *ApplianceAllOfPortalExternalProfiles {
	return v.value
}

func (v *NullableApplianceAllOfPortalExternalProfiles) Set(val *ApplianceAllOfPortalExternalProfiles) {
	v.value = val
	v.isSet = true
}

func (v NullableApplianceAllOfPortalExternalProfiles) IsSet() bool {
	return v.isSet
}

func (v *NullableApplianceAllOfPortalExternalProfiles) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableApplianceAllOfPortalExternalProfiles(val *ApplianceAllOfPortalExternalProfiles) *NullableApplianceAllOfPortalExternalProfiles {
	return &NullableApplianceAllOfPortalExternalProfiles{value: val, isSet: true}
}

func (v NullableApplianceAllOfPortalExternalProfiles) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableApplianceAllOfPortalExternalProfiles) UnmarshalJSON(src []byte) error {
	v.isSet = true
