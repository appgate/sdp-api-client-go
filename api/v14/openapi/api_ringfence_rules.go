...
func (r apiRingfenceRulesGetRequest) Execute() (RingfenceRuleList, *_nethttp.Response, error) {
	...
	localBasePath, err := r.apiService.client.cfg.ServerURLWithContext(r.ctx, "RingfenceRulesApiService.RingfenceRulesGet")
	if err != nil {
...
func (r apiRingfenceRulesIdGetRequest) Execute() (RingfenceRule, *_nethttp.Response, error) {
	...
	localBasePath, err := r.apiService.client.cfg.ServerURLWithContext(r.ctx, "RingfenceRulesApiService.RingfenceRulesIdGet")
	if err != nil {
		return localVarReturnValue, nil, GenericOpenAPIError{error: err.Error()}
	}
...
func (r apiRingfenceRulesIdPutRequest) Execute() (RingfenceRule, *_nethttp.Response, error) {
	...
	localBasePath, err := r.apiService.client.cfg.ServerURLWithContext(r.ctx, "RingfenceRulesApiService.RingfenceRulesIdPut")
	if err != nil {
		return localVarReturnValue, nil, GenericOpenAPIError{error: err.Error()}
	}
...
func (r apiRingfenceRulesPostRequest) Execute() (RingfenceRule, *_nethttp.Response, error) {
	...
	localBasePath, err := r.apiService.client.cfg.ServerURLWithContext(r.ctx, "RingfenceRulesApiService.RingfenceRulesPost")
	if err != nil {
		return localVarReturnValue, nil, GenericOpenAPIError{error: err.Error()}
	}
