...
Execute executes the request
	...
	@return BaseStats
*/
func (r apiStatsAppDiscoveryGetRequest) Execute() (BaseStats, *_nethttp.Response, error) {
	var (
	...
	localBasePath, err := r.apiService.client.cfg.ServerURLWithContext(r.ctx, "DiscoveredAppsApiService.StatsAppDiscoveryGet")
	if err != nil {
