...
Get all the Prometheus metrics for the given Appliance. This API call must be made with **Accept** header of **application/vnd.appgate.peer-v14+text** as it returns plain text instead of JSON.
...
func (r apiAppliancesIdMetricsGetRequest) Execute() (string, *_nethttp.Response, error) {
	...
	localBasePath, err := r.apiService.client.cfg.ServerURLWithContext(r.ctx, "ApplianceMetricsApiService.AppliancesIdMetricsGet")
	if err != nil {
...
Get a specific Prometheus metrics for the given Appliance. This API call must be made with **Accept** header of **application/vnd.appgate.peer-v14+text** as it returns plain text instead of JSON.
  - @param ctx _context.Context - for authentication, logging, cancellation, deadlines, tracing, etc. Passed from http.Request or context.Background().
  - @param id ID of the object.
...
func (r apiAppliancesIdMetricsNameGetRequest) Execute() (string, *_nethttp.Response, error) {
	...
	localBasePath, err := r.apiService.client.cfg.ServerURLWithContext(r.ctx, "ApplianceMetricsApiService.AppliancesIdMetricsNameGet")
	if err != nil {
		return localVarReturnValue, nil, GenericOpenAPIError{error: err.Error()}
	}
