...
func (r apiEntitlementsGetRequest) Execute() (EntitlementList, *_nethttp.Response, error) {
	...
	localBasePath, err := r.apiService.client.cfg.ServerURLWithContext(r.ctx, "EntitlementsApiService.EntitlementsGet")
	if err != nil {
...
func (r apiEntitlementsIdGetRequest) Execute() (Entitlement, *_nethttp.Response, error) {
	...
	localBasePath, err := r.apiService.client.cfg.ServerURLWithContext(r.ctx, "EntitlementsApiService.EntitlementsIdGet")
	if err != nil {
		return localVarReturnValue, nil, GenericOpenAPIError{error: err.Error()}
	}
...
func (r apiEntitlementsIdPutRequest) Execute() (Entitlement, *_nethttp.Response, error) {
	...
	localBasePath, err := r.apiService.client.cfg.ServerURLWithContext(r.ctx, "EntitlementsApiService.EntitlementsIdPut")
	if err != nil {
		return localVarReturnValue, nil, GenericOpenAPIError{error: err.Error()}
	}
...
func (r apiEntitlementsPostRequest) Execute() (Entitlement, *_nethttp.Response, error) {
	...
	localBasePath, err := r.apiService.client.cfg.ServerURLWithContext(r.ctx, "EntitlementsApiService.EntitlementsPost")
	if err != nil {
		return localVarReturnValue, nil, GenericOpenAPIError{error: err.Error()}
	}
