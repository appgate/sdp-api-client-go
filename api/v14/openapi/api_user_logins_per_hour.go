...
Execute executes the request
	...
	@return BaseStats
*/
func (r apiStatsUserLoginsGetRequest) Execute() (BaseStats, *_nethttp.Response, error) {
	var (
	...
	localBasePath, err := r.apiService.client.cfg.ServerURLWithContext(r.ctx, "UserLoginsPerHourApiService.StatsUserLoginsGet")
	if err != nil {
