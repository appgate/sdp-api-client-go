...
Execute executes the request
	...
	@return BaseStats
*/
func (r apiStatsAppliancesGetRequest) Execute() (BaseStats, *_nethttp.Response, error) {
	var (
	...
	localBasePath, err := r.apiService.client.cfg.ServerURLWithContext(r.ctx, "ApplianceStatsApiService.StatsAppliancesGet")
	if err != nil {
