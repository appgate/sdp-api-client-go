...
Execute executes the request
	...
	@return BaseStats
*/
func (r apiStatsFailedAuthenticationsGetRequest) Execute() (BaseStats, *_nethttp.Response, error) {
	var (
	...
	localBasePath, err := r.apiService.client.cfg.ServerURLWithContext(r.ctx, "FailedAuthenticationsPerHourApiService.StatsFailedAuthenticationsGet")
	if err != nil {
