...
// checks if the OtpSeedList type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &OtpSeedList{}
...
// NewOtpSeedList instantiates a new OtpSeedList object
...
// NewOtpSeedListWithDefaults instantiates a new OtpSeedList object
...
func (o *OtpSeedList) GetTotalCount() int32 {
...
// and a boolean to check if the value has been set.
func (o *OtpSeedList) GetTotalCountOk() (*int32, bool) {
	if o == nil || IsNil(o.TotalCount) {
		return nil, false
	}
...
func (o *OtpSeedList) HasTotalCount() bool {
	if o != nil && !IsNil(o.TotalCount) {
		return true
	}
...
func (o *OtpSeedList) SetTotalCount(v int32) {
	o.TotalCount = &v
}
...
func (o OtpSeedList) ToMap() (map[string]interface{}, error) {
...
func NewNullableOtpSeedList(val *OtpSeedList) *NullableOtpSeedList {
	return &NullableOtpSeedList{value: val, isSet: true}
}
