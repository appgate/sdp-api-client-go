...
// checks if the IpPoolAllOfRanges type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &IpPoolAllOfRanges{}

// IpPoolAllOfRanges struct for IpPoolAllOfRanges
...
func (o IpPoolAllOfRanges) ToMap() (map[string]interface{}, error) {
