...
func (r ApiColorsGetRequest) Query(query string) ApiColorsGetRequest {
	r.query = &query
	return r
}
...
func (r ApiColorsGetRequest) Range_(range_ string) ApiColorsGetRequest {
	r.range_ = &range_
	return r
}
...
func (r ApiColorsGetRequest) OrderBy(orderBy string) ApiColorsGetRequest {
	r.orderBy = &orderBy
	return r
}

// Whether the sorting is applied descending or ascending. Defaults to certain field depending on the object type.
func (r ApiColorsGetRequest) Descending(descending string) ApiColorsGetRequest {
...
func (r ApiColorsGetRequest) FilterBy(filterBy map[string]string) ApiColorsGetRequest {
	r.filterBy = &filterBy
	return r
}

func (r ApiColorsGetRequest) Execute() (*ColorList, *http.Response, error) {
	return r.ApiService.ColorsGetExecute(r)
}

/*
ColorsGet List all color codes.

Get a list of all supported color codes.
...
func (a *ColorsAPIService) ColorsGetExecute(r ApiColorsGetRequest) (*ColorList, *http.Response, error) {
	...
	localVarPath := localBasePath + "/colors"
