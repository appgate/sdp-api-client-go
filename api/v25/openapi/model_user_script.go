...
func (o *UserScript) SetReadOnly(v bool) {
	o.ReadOnly = &v
}
...
func (o *UserScript) UnmarshalJSON(data []byte) (err error) {
	...
	varUserScript := _UserScript{}

	decoder := json.NewDecoder(bytes.NewReader(data))
	decoder.DisallowUnknownFields()
	err = decoder.Decode(&varUserScript)

	if err != nil {
		return err
	}

	*o = UserScript(varUserScript)
