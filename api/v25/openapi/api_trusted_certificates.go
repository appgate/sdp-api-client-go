...
// Bulk upsert request.
func (r ApiTrustedCertificatesBulkUpsertPostRequest) TrustedCertificatesBulkUpsertPostRequest(trustedCertificatesBulkUpsertPostRequest TrustedCertificatesBulkUpsertPostRequest) ApiTrustedCertificatesBulkUpsertPostRequest {
	r.trustedCertificatesBulkUpsertPostRequest = &trustedCertificatesBulkUpsertPostRequest
	return r
}

func (r ApiTrustedCertificatesBulkUpsertPostRequest) Execute() (*BulkUpsertReport, *http.Response, error) {
	return r.ApiService.TrustedCertificatesBulkUpsertPostExecute(r)
}

/*
TrustedCertificatesBulkUpsertPost Bulk upsert Trusted Certificates.

Create or update multiple trusted certificates in a single request.
...
func (a *TrustedCertificatesApiService) TrustedCertificatesBulkUpsertPostExecute(r ApiTrustedCertificatesBulkUpsertPostRequest) (*BulkUpsertReport, *http.Response, error) {
	...
	localVarPath := localBasePath + "/trusted-certificates/bulk-upsert"

	localVarHeaderParams := make(map[string]string)
	localVarQueryParams := url.Values{}
	localVarFormParams := url.Values{}
	if r.trustedCertificatesBulkUpsertPostRequest == nil {
		return localVarReturnValue, nil, reportError("trustedCertificatesBulkUpsertPostRequest is required and must be specified")
	}
	...
	// body params
	localVarPostBody = r.trustedCertificatesBulkUpsertPostRequest
