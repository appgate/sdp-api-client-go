...
// checks if the ApplianceList type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &ApplianceList{}
...
func (o *ApplianceList) GetTotalCount() int32 {
...
// and a boolean to check if the value has been set.
func (o *ApplianceList) GetTotalCountOk() (*int32, bool) {
	if o == nil || IsNil(o.TotalCount) {
		return nil, false
	}
...
func (o *ApplianceList) HasTotalCount() bool {
	if o != nil && !IsNil(o.TotalCount) {
		return true
	}
...
func (o *ApplianceList) SetTotalCount(v int32) {
	o.TotalCount = &v
}
...
func (o ApplianceList) ToMap() (map[string]interface{}, error) {
