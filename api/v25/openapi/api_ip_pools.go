...
type ApiIpPoolsBulkUpsertPostRequest struct {
	ctx                          context.Context
	ApiService                   *IPPoolsApiService
	ipPoolsBulkUpsertPostRequest *IpPoolsBulkUpsertPostRequest
}

// Bulk upsert request.
func (r ApiIpPoolsBulkUpsertPostRequest) IpPoolsBulkUpsertPostRequest(ipPoolsBulkUpsertPostRequest IpPoolsBulkUpsertPostRequest) ApiIpPoolsBulkUpsertPostRequest {
	r.ipPoolsBulkUpsertPostRequest = &ipPoolsBulkUpsertPostRequest
	return r
}

func (r ApiIpPoolsBulkUpsertPostRequest) Execute() (*BulkUpsertReport, *http.Response, error) {
	return r.ApiService.IpPoolsBulkUpsertPostExecute(r)
}

/*
IpPoolsBulkUpsertPost Bulk upsert IP Pools.

Create or update multiple ip pools in a single request.

	@param ctx context.Context - for authentication, logging, cancellation, deadlines, tracing, etc. Passed from http.Request or context.Background().
	@return ApiIpPoolsBulkUpsertPostRequest
*/
func (a *IPPoolsApiService) IpPoolsBulkUpsertPost(ctx context.Context) ApiIpPoolsBulkUpsertPostRequest {
	return ApiIpPoolsBulkUpsertPostRequest{
		ApiService: a,
		ctx:        ctx,
	}
...
func (a *IPPoolsApiService) IpPoolsBulkUpsertPostExecute(r ApiIpPoolsBulkUpsertPostRequest) (*BulkUpsertReport, *http.Response, error) {
	var (
	...
	localBasePath, err := a.client.cfg.ServerURLWithContext(r.ctx, "IPPoolsApiService.IpPoolsBulkUpsertPost")
	if err != nil {
		return localVarReturnValue, nil, &GenericOpenAPIError{error: err.Error()}
	}

	localVarPath := localBasePath + "/ip-pools/bulk-upsert"

	localVarHeaderParams := make(map[string]string)
	localVarQueryParams := url.Values{}
	localVarFormParams := url.Values{}
	if r.ipPoolsBulkUpsertPostRequest == nil {
		return localVarReturnValue, nil, reportError("ipPoolsBulkUpsertPostRequest is required and must be specified")
	}
	...
	// body params
	localVarPostBody = r.ipPoolsBulkUpsertPostRequest
	req, err := a.client.prepareRequest(r.ctx, localVarPath, localVarHTTPMethod, localVarPostBody, localVarHeaderParams, localVarQueryParams, localVarFormParams, formFiles)
	if err != nil {
		return localVarReturnValue, nil, err
	}
