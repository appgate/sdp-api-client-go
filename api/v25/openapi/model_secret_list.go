...
func (o *SecretList) GetRange() string {
...
func (o *SecretList) GetRangeOk() (*string, bool) {
	if o == nil || IsNil(o.Range) {
		return nil, false
	}
	return o.Range, true
...
func (o *SecretList) HasRange() bool {
	if o != nil && !IsNil(o.Range) {
		return true
	}
...
func (o *SecretList) SetRange(v string) {
	o.Range = &v
}

// GetOrderBy returns the OrderBy field value if set, zero value otherwise.
func (o *SecretList) GetOrderBy() string {
...
// and a boolean to check if the value has been set.
func (o *SecretList) GetOrderByOk() (*string, bool) {
	if o == nil || IsNil(o.OrderBy) {
		return nil, false
	}
...
func (o *SecretList) HasOrderBy() bool {
	if o != nil && !IsNil(o.OrderBy) {
		return true
	}
...
// and a boolean to check if the value has been set.
func (o *SecretList) GetDescendingOk() (*bool, bool) {
	if o == nil || IsNil(o.Descending) {
		return nil, false
	}
...
func (o *SecretList) HasDescending() bool {
	if o != nil && !IsNil(o.Descending) {
		return true
	}
...
func (o *SecretList) SetDescending(v bool) {
	o.Descending = &v
}

// GetQueries returns the Queries field value if set, zero value otherwise.
func (o *SecretList) GetQueries() []string {
...
// and a boolean to check if the value has been set.
func (o *SecretList) GetQueriesOk() ([]string, bool) {
	if o == nil || IsNil(o.Queries) {
		return nil, false
	}
...
func (o *SecretList) HasQueries() bool {
	if o != nil && !IsNil(o.Queries) {
		return true
	}
...
func (o *SecretList) SetQueries(v []string) {
	o.Queries = v
}

// GetTotalCount returns the TotalCount field value if set, zero value otherwise.
func (o *SecretList) GetTotalCount() int32 {
...
// and a boolean to check if the value has been set.
func (o *SecretList) GetTotalCountOk() (*int32, bool) {
	if o == nil || IsNil(o.TotalCount) {
		return nil, false
	}
...
func (o *SecretList) HasTotalCount() bool {
	if o != nil && !IsNil(o.TotalCount) {
		return true
	}
...
func (o *SecretList) SetTotalCount(v int32) {
	o.TotalCount = &v
}

// GetFilterBy returns the FilterBy field value if set, zero value otherwise.
func (o *SecretList) GetFilterBy() []FilterBy {
...
// and a boolean to check if the value has been set.
func (o *SecretList) GetFilterByOk() ([]FilterBy, bool) {
	if o == nil || IsNil(o.FilterBy) {
		return nil, false
	}
...
func (o *SecretList) HasFilterBy() bool {
	if o != nil && !IsNil(o.FilterBy) {
		return true
	}
...
func (o *SecretList) SetFilterBy(v []FilterBy) {
	o.FilterBy = v
}

// GetData returns the Data field value if set, zero value otherwise.
func (o *SecretList) GetData() []map[string]interface{} {
...
// and a boolean to check if the value has been set.
func (o *SecretList) GetDataOk() ([]map[string]interface{}, bool) {
	if o == nil || IsNil(o.Data) {
		return nil, false
	}
	return o.Data, true
...
func (o *SecretList) HasData() bool {
	if o != nil && !IsNil(o.Data) {
		return true
	}
...
func (o *SecretList) SetData(v []map[string]interface{}) {
	o.Data = v
}
