...
type ApiMfaProvidersBulkUpsertPostRequest struct {
	ctx                               context.Context
	ApiService                        *MFAProvidersApiService
	mfaProvidersBulkUpsertPostRequest *MfaProvidersBulkUpsertPostRequest
}

// Bulk upsert request.
func (r ApiMfaProvidersBulkUpsertPostRequest) MfaProvidersBulkUpsertPostRequest(mfaProvidersBulkUpsertPostRequest MfaProvidersBulkUpsertPostRequest) ApiMfaProvidersBulkUpsertPostRequest {
	r.mfaProvidersBulkUpsertPostRequest = &mfaProvidersBulkUpsertPostRequest
	return r
}

func (r ApiMfaProvidersBulkUpsertPostRequest) Execute() (*BulkUpsertReport, *http.Response, error) {
	return r.ApiService.MfaProvidersBulkUpsertPostExecute(r)
}

/*
MfaProvidersBulkUpsertPost Bulk upsert MFA Providers.

Create or update multiple mfa providers in a single request.

	@param ctx context.Context - for authentication, logging, cancellation, deadlines, tracing, etc. Passed from http.Request or context.Background().
	@return ApiMfaProvidersBulkUpsertPostRequest
*/
func (a *MFAProvidersApiService) MfaProvidersBulkUpsertPost(ctx context.Context) ApiMfaProvidersBulkUpsertPostRequest {
	return ApiMfaProvidersBulkUpsertPostRequest{
		ApiService: a,
		ctx:        ctx,
	}
...
func (a *MFAProvidersApiService) MfaProvidersBulkUpsertPostExecute(r ApiMfaProvidersBulkUpsertPostRequest) (*BulkUpsertReport, *http.Response, error) {
	var (
	...
	localBasePath, err := a.client.cfg.ServerURLWithContext(r.ctx, "MFAProvidersApiService.MfaProvidersBulkUpsertPost")
	if err != nil {
		return localVarReturnValue, nil, &GenericOpenAPIError{error: err.Error()}
	}

	localVarPath := localBasePath + "/mfa-providers/bulk-upsert"

	localVarHeaderParams := make(map[string]string)
	localVarQueryParams := url.Values{}
	localVarFormParams := url.Values{}
	if r.mfaProvidersBulkUpsertPostRequest == nil {
		return localVarReturnValue, nil, reportError("mfaProvidersBulkUpsertPostRequest is required and must be specified")
	}
	...
	// body params
	localVarPostBody = r.mfaProvidersBulkUpsertPostRequest
