...
type NetworkInfo struct {
	...
	Details *map[string]NetworkInfoDetailsValue `json:"details,omitempty"`
}
...
func (o *NetworkInfo) SetBusiestNic(v string) {
	o.BusiestNic = &v
}
...
// SetDetails gets a reference to the given map[string]NetworkInfoDetailsValue and assigns it to the Details field.
func (o *NetworkInfo) SetDetails(v map[string]NetworkInfoDetailsValue) {
	o.Details = &v
}
