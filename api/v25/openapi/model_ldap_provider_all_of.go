...
// checks if the LdapProviderAllOf type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &LdapProviderAllOf{}
...
func (o LdapProviderAllOf) ToMap() (map[string]interface{}, error) {
