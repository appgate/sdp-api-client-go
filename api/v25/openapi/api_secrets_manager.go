...
func (r ApiSecretsIdGetRequest) Execute() (map[string]interface{}, *http.Response, error) {
...
func (a *SecretsManagerAPIService) SecretsIdGetExecute(r ApiSecretsIdGetRequest) (map[string]interface{}, *http.Response, error) {
	var (
		localVarHTTPMethod  = http.MethodGet
		localVarPostBody    interface{}
		formFiles           []formFile
...
// Secret object.
func (r ApiSecretsIdPutRequest) Body(body map[string]interface{}) ApiSecretsIdPutRequest {
	r.body = &body
	return r
}

func (r ApiSecretsIdPutRequest) Execute() (map[string]interface{}, *http.Response, error) {
...
//
//	@return map[string]interface{}
func (a *SecretsManagerAPIService) SecretsIdPutExecute(r ApiSecretsIdPutRequest) (map[string]interface{}, *http.Response, error) {
	var (
...
// Secret object.
func (r ApiSecretsPostRequest) Body(body map[string]interface{}) ApiSecretsPostRequest {
	r.body = &body
	return r
}

func (r ApiSecretsPostRequest) Execute() (map[string]interface{}, *http.Response, error) {
...
//
//	@return map[string]interface{}
func (a *SecretsManagerAPIService) SecretsPostExecute(r ApiSecretsPostRequest) (map[string]interface{}, *http.Response, error) {
	var (
