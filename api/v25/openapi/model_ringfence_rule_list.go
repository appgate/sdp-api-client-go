...
// checks if the RingfenceRuleList type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &RingfenceRuleList{}
...
// NewRingfenceRuleList instantiates a new RingfenceRuleList object
// This constructor will assign default values to properties that have it defined,
// and makes sure properties required by API are set, but the set of arguments
// will change when the set of required properties is changed
func NewRingfenceRuleList() *RingfenceRuleList {
	this := RingfenceRuleList{}
	return &this
}

// NewRingfenceRuleListWithDefaults instantiates a new RingfenceRuleList object
...
func (o *RingfenceRuleList) GetTotalCount() int32 {
...
// and a boolean to check if the value has been set.
func (o *RingfenceRuleList) GetTotalCountOk() (*int32, bool) {
	if o == nil || IsNil(o.TotalCount) {
		return nil, false
	}
...
func (o *RingfenceRuleList) HasTotalCount() bool {
	if o != nil && !IsNil(o.TotalCount) {
		return true
	}
...
func (o *RingfenceRuleList) SetTotalCount(v int32) {
	o.TotalCount = &v
}
...
func (o RingfenceRuleList) ToMap() (map[string]interface{}, error) {
...
func NewNullableRingfenceRuleList(val *RingfenceRuleList) *NullableRingfenceRuleList {
	return &NullableRingfenceRuleList{value: val, isSet: true}
}
