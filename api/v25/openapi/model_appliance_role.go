...
// checks if the ApplianceRole type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &ApplianceRole{}
...
func (o ApplianceRole) ToMap() (map[string]interface{}, error) {
