...
// checks if the PolicyListAllOf type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &PolicyListAllOf{}
...
// NewPolicyListAllOf instantiates a new PolicyListAllOf object
// This constructor will assign default values to properties that have it defined,
// and makes sure properties required by API are set, but the set of arguments
// will change when the set of required properties is changed
func NewPolicyListAllOf() *PolicyListAllOf {
	this := PolicyListAllOf{}
	return &this
}

// NewPolicyListAllOfWithDefaults instantiates a new PolicyListAllOf object
...
func (o PolicyListAllOf) ToMap() (map[string]interface{}, error) {
...
func NewNullablePolicyListAllOf(val *PolicyListAllOf) *NullablePolicyListAllOf {
	return &NullablePolicyListAllOf{value: val, isSet: true}
}
