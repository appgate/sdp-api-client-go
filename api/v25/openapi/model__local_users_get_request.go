...
func (o *LocalUsersGetRequest) GetReadOnly() bool {
...
// and a boolean to check if the value has been set.
func (o *LocalUsersGetRequest) GetReadOnlyOk() (*bool, bool) {
	if o == nil || o.ReadOnly == nil {
		return nil, false
	}
...
func (o *LocalUsersGetRequest) HasReadOnly() bool {
	if o != nil && o.ReadOnly != nil {
		return true
	}
...
func (o *LocalUsersGetRequest) SetReadOnly(v bool) {
	o.ReadOnly = &v
}
