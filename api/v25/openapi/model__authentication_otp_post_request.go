...
func NewAuthenticationOtpPostRequest(otp string) *AuthenticationOtpPostRequest {
	this := AuthenticationOtpPostRequest{}
	this.Otp = otp
	return &this
}

// NewAuthenticationOtpPostRequestWithDefaults instantiates a new AuthenticationOtpPostRequest object
...
type NullableAuthenticationOtpPostRequest struct {
	value *AuthenticationOtpPostRequest
	isSet bool
}
...
func NewNullableAuthenticationOtpPostRequest(val *AuthenticationOtpPostRequest) *NullableAuthenticationOtpPostRequest {
	return &NullableAuthenticationOtpPostRequest{value: val, isSet: true}
}
