...
func (o *LocalUser) GetReadOnly() bool {
...
// and a boolean to check if the value has been set.
func (o *LocalUser) GetReadOnlyOk() (*bool, bool) {
	if o == nil || IsNil(o.ReadOnly) {
		return nil, false
	}
...
func (o *LocalUser) HasReadOnly() bool {
	if o != nil && !IsNil(o.ReadOnly) {
		return true
	}
...
func (o *LocalUser) SetReadOnly(v bool) {
	o.ReadOnly = &v
}
...
func (o *LocalUser) UnmarshalJSON(data []byte) (err error) {
	...
	varLocalUser := _LocalUser{}

	decoder := json.NewDecoder(bytes.NewReader(data))
	decoder.DisallowUnknownFields()
	err = decoder.Decode(&varLocalUser)

	if err != nil {
		return err
	}

	*o = LocalUser(varLocalUser)
