...
type SiteAllOfNameResolutionDnsResolvers struct {
	...
	ZonesTransfers *bool `json:"zonesTransfers,omitempty"`
...
func NewSiteAllOfNameResolutionDnsResolvers(name string) *SiteAllOfNameResolutionDnsResolvers {
	...
	var zonesTransfers bool = false
	this.ZonesTransfers = &zonesTransfers
	return &this
}
...
// SetZonesTransfers gets a reference to the given bool and assigns it to the ZonesTransfers field.
func (o *SiteAllOfNameResolutionDnsResolvers) SetZonesTransfers(v bool) {
	o.ZonesTransfers = &v
}
...
func (o *SiteAllOfNameResolutionDnsResolvers) SetAutoClientDns(v bool) {
	o.AutoClientDns = &v
}
