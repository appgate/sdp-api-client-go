...
// checks if the Fido2DeviceList type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &Fido2DeviceList{}
...
func (o *Fido2DeviceList) GetTotalCount() int32 {
...
// and a boolean to check if the value has been set.
func (o *Fido2DeviceList) GetTotalCountOk() (*int32, bool) {
	if o == nil || IsNil(o.TotalCount) {
		return nil, false
	}
...
func (o *Fido2DeviceList) HasTotalCount() bool {
	if o != nil && !IsNil(o.TotalCount) {
		return true
	}
...
func (o *Fido2DeviceList) SetTotalCount(v int32) {
	o.TotalCount = &v
}
...
func (o Fido2DeviceList) ToMap() (map[string]interface{}, error) {
