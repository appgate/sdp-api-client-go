...
// checks if the CriteriaScriptListAllOf type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &CriteriaScriptListAllOf{}
...
func (o CriteriaScriptListAllOf) ToMap() (map[string]interface{}, error) {
