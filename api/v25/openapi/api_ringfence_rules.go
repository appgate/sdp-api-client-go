...
type ApiRingfenceRulesBulkUpsertPostRequest struct {
	ctx                                 context.Context
	ApiService                          *RingfenceRulesApiService
	ringfenceRulesBulkUpsertPostRequest *RingfenceRulesBulkUpsertPostRequest
}

// Bulk upsert request.
func (r ApiRingfenceRulesBulkUpsertPostRequest) RingfenceRulesBulkUpsertPostRequest(ringfenceRulesBulkUpsertPostRequest RingfenceRulesBulkUpsertPostRequest) ApiRingfenceRulesBulkUpsertPostRequest {
	r.ringfenceRulesBulkUpsertPostRequest = &ringfenceRulesBulkUpsertPostRequest
	return r
}

func (r ApiRingfenceRulesBulkUpsertPostRequest) Execute() (*BulkUpsertReport, *http.Response, error) {
	return r.ApiService.RingfenceRulesBulkUpsertPostExecute(r)
}

/*
RingfenceRulesBulkUpsertPost Bulk upsert Ringfence Rules.

Create or update multiple ringfence rules in a single request.

	@param ctx context.Context - for authentication, logging, cancellation, deadlines, tracing, etc. Passed from http.Request or context.Background().
	@return ApiRingfenceRulesBulkUpsertPostRequest
*/
func (a *RingfenceRulesApiService) RingfenceRulesBulkUpsertPost(ctx context.Context) ApiRingfenceRulesBulkUpsertPostRequest {
	return ApiRingfenceRulesBulkUpsertPostRequest{
		ApiService: a,
		ctx:        ctx,
	}
...
func (a *RingfenceRulesApiService) RingfenceRulesBulkUpsertPostExecute(r ApiRingfenceRulesBulkUpsertPostRequest) (*BulkUpsertReport, *http.Response, error) {
	var (
	...
	localBasePath, err := a.client.cfg.ServerURLWithContext(r.ctx, "RingfenceRulesApiService.RingfenceRulesBulkUpsertPost")
	if err != nil {
		return localVarReturnValue, nil, &GenericOpenAPIError{error: err.Error()}
	}

	localVarPath := localBasePath + "/ringfence-rules/bulk-upsert"

	localVarHeaderParams := make(map[string]string)
	localVarQueryParams := url.Values{}
	localVarFormParams := url.Values{}
	if r.ringfenceRulesBulkUpsertPostRequest == nil {
		return localVarReturnValue, nil, reportError("ringfenceRulesBulkUpsertPostRequest is required and must be specified")
	}
	...
	// body params
	localVarPostBody = r.ringfenceRulesBulkUpsertPostRequest
