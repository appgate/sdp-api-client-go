...
// checks if the ConnectorProvider type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &ConnectorProvider{}
...
type _ConnectorProvider ConnectorProvider
...
// NewConnectorProviderWithDefaults instantiates a new ConnectorProvider object
...
func (o *ConnectorProvider) GetReadOnly() bool {
...
// and a boolean to check if the value has been set.
func (o *ConnectorProvider) GetReadOnlyOk() (*bool, bool) {
	if o == nil || IsNil(o.ReadOnly) {
		return nil, false
	}
...
func (o *ConnectorProvider) HasReadOnly() bool {
	if o != nil && !IsNil(o.ReadOnly) {
		return true
	}
...
func (o *ConnectorProvider) SetReadOnly(v bool) {
	o.ReadOnly = &v
}
...
func (o ConnectorProvider) ToMap() (map[string]interface{}, error) {
...
func (o *ConnectorProvider) UnmarshalJSON(data []byte) (err error) {
	...
	varConnectorProvider := _ConnectorProvider{}

	decoder := json.NewDecoder(bytes.NewReader(data))
	decoder.DisallowUnknownFields()
	err = decoder.Decode(&varConnectorProvider)

	if err != nil {
		return err
	}

	*o = ConnectorProvider(varConnectorProvider)
