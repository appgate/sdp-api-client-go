...
func (o *AwsKinesis) UnmarshalJSON(data []byte) (err error) {
	...
	varAwsKinesis := _AwsKinesis{}

	decoder := json.NewDecoder(bytes.NewReader(data))
	decoder.DisallowUnknownFields()
	err = decoder.Decode(&varAwsKinesis)

	if err != nil {
		return err
	}

	*o = AwsKinesis(varAwsKinesis)
