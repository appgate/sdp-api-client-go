...
type _AppliancesForceDisableControllersPostRequest AppliancesForceDisableControllersPostRequest

// NewAppliancesForceDisableControllersPostRequest instantiates a new AppliancesForceDisableControllersPostRequest object
...
func NewAppliancesForceDisableControllersPostRequest(applianceIds []string) *AppliancesForceDisableControllersPostRequest {
	this := AppliancesForceDisableControllersPostRequest{}
	this.ApplianceIds = applianceIds
	return &this
}

// NewAppliancesForceDisableControllersPostRequestWithDefaults instantiates a new AppliancesForceDisableControllersPostRequest object
...
func (o *AppliancesForceDisableControllersPostRequest) GetApplianceIds() []string {
	...
	return o.ApplianceIds
}

// GetApplianceIdsOk returns a tuple with the ApplianceIds field value
// and a boolean to check if the value has been set.
func (o *AppliancesForceDisableControllersPostRequest) GetApplianceIdsOk() ([]string, bool) {
	if o == nil {
		return nil, false
	}
	return o.ApplianceIds, true
}
...
func (o *AppliancesForceDisableControllersPostRequest) UnmarshalJSON(data []byte) (err error) {
	...
	varAppliancesForceDisableControllersPostRequest := _AppliancesForceDisableControllersPostRequest{}

	decoder := json.NewDecoder(bytes.NewReader(data))
	decoder.DisallowUnknownFields()
	err = decoder.Decode(&varAppliancesForceDisableControllersPostRequest)

	if err != nil {
		return err
	}

	*o = AppliancesForceDisableControllersPostRequest(varAppliancesForceDisableControllersPostRequest)

	return err
}

type NullableAppliancesForceDisableControllersPostRequest struct {
	value *AppliancesForceDisableControllersPostRequest
	isSet bool
}
...
func NewNullableAppliancesForceDisableControllersPostRequest(val *AppliancesForceDisableControllersPostRequest) *NullableAppliancesForceDisableControllersPostRequest {
	return &NullableAppliancesForceDisableControllersPostRequest{value: val, isSet: true}
}
