...
type _DeviceScript DeviceScript
...
func (o *DeviceScript) GetReadOnly() bool {
...
// and a boolean to check if the value has been set.
func (o *DeviceScript) GetReadOnlyOk() (*bool, bool) {
	if o == nil || IsNil(o.ReadOnly) {
		return nil, false
	}
...
func (o *DeviceScript) HasReadOnly() bool {
	if o != nil && !IsNil(o.ReadOnly) {
		return true
	}
...
func (o *DeviceScript) SetReadOnly(v bool) {
	o.ReadOnly = &v
}
...
func (o *DeviceScript) UnmarshalJSON(data []byte) (err error) {
	...
	varDeviceScript := _DeviceScript{}

	decoder := json.NewDecoder(bytes.NewReader(data))
	decoder.DisallowUnknownFields()
	err = decoder.Decode(&varDeviceScript)

	if err != nil {
		return err
	}

	*o = DeviceScript(varDeviceScript)
