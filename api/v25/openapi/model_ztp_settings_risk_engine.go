...
type ZtpSettingsRiskEngine struct {
	...
	DynamicAlerts  *bool                                `json:"dynamicAlerts,omitempty"`
...
func NewZtpSettingsRiskEngine() *ZtpSettingsRiskEngine {
	...
	var dynamicAlerts bool = true
	this.DynamicAlerts = &dynamicAlerts
	return &this
}
...
// SetDynamicAlerts gets a reference to the given bool and assigns it to the DynamicAlerts field.
func (o *ZtpSettingsRiskEngine) SetDynamicAlerts(v bool) {
	o.DynamicAlerts = &v
}
