...
// checks if the AdminMessagesList type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &AdminMessagesList{}
...
// NewAdminMessagesList instantiates a new AdminMessagesList object
...
// NewAdminMessagesListWithDefaults instantiates a new AdminMessagesList object
...
func (o *AdminMessagesList) GetData() []AdminMessagesListDataInner {
	if o == nil || IsNil(o.Data) {
		var ret []AdminMessagesListDataInner
		return ret
	}
	return o.Data
}
...
func (o AdminMessagesList) ToMap() (map[string]interface{}, error) {
...
func NewNullableAdminMessagesList(val *AdminMessagesList) *NullableAdminMessagesList {
	return &NullableAdminMessagesList{value: val, isSet: true}
}
