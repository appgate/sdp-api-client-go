...
// checks if the RingfenceRule type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &RingfenceRule{}
...
type _RingfenceRule RingfenceRule

// NewRingfenceRule instantiates a new RingfenceRule object
...
// NewRingfenceRuleWithDefaults instantiates a new RingfenceRule object
...
func (o *RingfenceRule) GetReadOnly() bool {
...
// and a boolean to check if the value has been set.
func (o *RingfenceRule) GetReadOnlyOk() (*bool, bool) {
	if o == nil || IsNil(o.ReadOnly) {
		return nil, false
	}
...
func (o *RingfenceRule) HasReadOnly() bool {
	if o != nil && !IsNil(o.ReadOnly) {
		return true
	}
...
func (o *RingfenceRule) SetReadOnly(v bool) {
	o.ReadOnly = &v
}
...
func (o RingfenceRule) ToMap() (map[string]interface{}, error) {
...
func (o *RingfenceRule) UnmarshalJSON(data []byte) (err error) {
	...
	varRingfenceRule := _RingfenceRule{}

	decoder := json.NewDecoder(bytes.NewReader(data))
	decoder.DisallowUnknownFields()
	err = decoder.Decode(&varRingfenceRule)

	if err != nil {
		return err
	}

	*o = RingfenceRule(varRingfenceRule)
...
func NewNullableRingfenceRule(val *RingfenceRule) *NullableRingfenceRule {
	return &NullableRingfenceRule{value: val, isSet: true}
}
