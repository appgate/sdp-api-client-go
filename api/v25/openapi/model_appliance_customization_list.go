...
// checks if the ApplianceCustomizationList type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &ApplianceCustomizationList{}
...
func (o ApplianceCustomizationList) ToMap() (map[string]interface{}, error) {
