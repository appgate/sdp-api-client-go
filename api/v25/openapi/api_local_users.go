...
// Bulk upsert request.
func (r ApiLocalUsersBulkUpsertPostRequest) LocalUsersBulkUpsertPostRequest(localUsersBulkUpsertPostRequest LocalUsersBulkUpsertPostRequest) ApiLocalUsersBulkUpsertPostRequest {
	r.localUsersBulkUpsertPostRequest = &localUsersBulkUpsertPostRequest
	return r
}

func (r ApiLocalUsersBulkUpsertPostRequest) Execute() (*BulkUpsertReport, *http.Response, error) {
	return r.ApiService.LocalUsersBulkUpsertPostExecute(r)
}

/*
LocalUsersBulkUpsertPost Bulk upsert Local Users.

Create or update multiple local users in a single request.
...
func (a *LocalUsersAPIService) LocalUsersBulkUpsertPostExecute(r ApiLocalUsersBulkUpsertPostRequest) (*BulkUpsertReport, *http.Response, error) {
	...
	localVarPath := localBasePath + "/local-users/bulk-upsert"

	localVarHeaderParams := make(map[string]string)
	localVarQueryParams := url.Values{}
	localVarFormParams := url.Values{}
	if r.localUsersBulkUpsertPostRequest == nil {
		return localVarReturnValue, nil, reportError("localUsersBulkUpsertPostRequest is required and must be specified")
	}
	...
	// body params
	localVarPostBody = r.localUsersBulkUpsertPostRequest
