...
// checks if the IdentityProviderList type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &IdentityProviderList{}
...
func (o *IdentityProviderList) GetTotalCount() int32 {
...
// and a boolean to check if the value has been set.
func (o *IdentityProviderList) GetTotalCountOk() (*int32, bool) {
	if o == nil || IsNil(o.TotalCount) {
		return nil, false
	}
...
func (o *IdentityProviderList) HasTotalCount() bool {
	if o != nil && !IsNil(o.TotalCount) {
		return true
	}
...
func (o *IdentityProviderList) SetTotalCount(v int32) {
	o.TotalCount = &v
}
...
func (o IdentityProviderList) ToMap() (map[string]interface{}, error) {
