...
// checks if the AdministrativeRoleList type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &AdministrativeRoleList{}
...
func (o *AdministrativeRoleList) GetTotalCount() int32 {
...
// and a boolean to check if the value has been set.
func (o *AdministrativeRoleList) GetTotalCountOk() (*int32, bool) {
	if o == nil || IsNil(o.TotalCount) {
		return nil, false
	}
...
func (o *AdministrativeRoleList) HasTotalCount() bool {
	if o != nil && !IsNil(o.TotalCount) {
		return true
	}
...
func (o *AdministrativeRoleList) SetTotalCount(v int32) {
	o.TotalCount = &v
}
...
func (o AdministrativeRoleList) ToMap() (map[string]interface{}, error) {
