...
type _SiteAllOfNameResolutionAwsResolvers SiteAllOfNameResolutionAwsResolvers
...
// SetEc2 gets a reference to the given bool and assigns it to the Ec2 field.
func (o *SiteAllOfNameResolutionAwsResolvers) SetEc2(v bool) {
	o.Ec2 = &v
}
...
// SetApiGateway gets a reference to the given bool and assigns it to the ApiGateway field.
func (o *SiteAllOfNameResolutionAwsResolvers) SetApiGateway(v bool) {
	o.ApiGateway = &v
}
...
// SetEks gets a reference to the given bool and assigns it to the Eks field.
func (o *SiteAllOfNameResolutionAwsResolvers) SetEks(v bool) {
	o.Eks = &v
}
...
// SetRds gets a reference to the given bool and assigns it to the Rds field.
func (o *SiteAllOfNameResolutionAwsResolvers) SetRds(v bool) {
	o.Rds = &v
}
...
func (o *SiteAllOfNameResolutionAwsResolvers) UnmarshalJSON(data []byte) (err error) {
	...
	varSiteAllOfNameResolutionAwsResolvers := _SiteAllOfNameResolutionAwsResolvers{}

	decoder := json.NewDecoder(bytes.NewReader(data))
	decoder.DisallowUnknownFields()
	err = decoder.Decode(&varSiteAllOfNameResolutionAwsResolvers)

	if err != nil {
		return err
	}

	*o = SiteAllOfNameResolutionAwsResolvers(varSiteAllOfNameResolutionAwsResolvers)
