...
// checks if the ConditionList type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &ConditionList{}
...
func (o *ConditionList) GetTotalCount() int32 {
...
// and a boolean to check if the value has been set.
func (o *ConditionList) GetTotalCountOk() (*int32, bool) {
	if o == nil || IsNil(o.TotalCount) {
		return nil, false
	}
...
func (o *ConditionList) HasTotalCount() bool {
	if o != nil && !IsNil(o.TotalCount) {
		return true
	}
...
func (o *ConditionList) SetTotalCount(v int32) {
	o.TotalCount = &v
}
...
func (o ConditionList) ToMap() (map[string]interface{}, error) {
