...
// NewUserScriptAllOf instantiates a new UserScriptAllOf object
// This constructor will assign default values to properties that have it defined,
// and makes sure properties required by API are set, but the set of arguments
// will change when the set of required properties is changed
func NewUserScriptAllOf(expression string) *UserScriptAllOf {
	this := UserScriptAllOf{}
	this.Expression = expression
	return &this
}

// NewUserScriptAllOfWithDefaults instantiates a new UserScriptAllOf object
...
func NewNullableUserScriptAllOf(val *UserScriptAllOf) *NullableUserScriptAllOf {
	return &NullableUserScriptAllOf{value: val, isSet: true}
}
