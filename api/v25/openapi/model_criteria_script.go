...
type _CriteriaScript CriteriaScript

// NewCriteriaScript instantiates a new CriteriaScript object
...
// NewCriteriaScriptWithDefaults instantiates a new CriteriaScript object
...
func (o *CriteriaScript) SetReadOnly(v bool) {
	o.ReadOnly = &v
}
...
func (o *CriteriaScript) UnmarshalJSON(data []byte) (err error) {
	...
	varCriteriaScript := _CriteriaScript{}

	decoder := json.NewDecoder(bytes.NewReader(data))
	decoder.DisallowUnknownFields()
	err = decoder.Decode(&varCriteriaScript)

	if err != nil {
		return err
	}

	*o = CriteriaScript(varCriteriaScript)

	return err
}

type NullableCriteriaScript struct {
	value *CriteriaScript
	isSet bool
}
...
func NewNullableCriteriaScript(val *CriteriaScript) *NullableCriteriaScript {
	return &NullableCriteriaScript{value: val, isSet: true}
}
