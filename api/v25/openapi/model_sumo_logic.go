...
func (o *SumoLogic) UnmarshalJSON(data []byte) (err error) {
	...
	varSumoLogic := _SumoLogic{}

	decoder := json.NewDecoder(bytes.NewReader(data))
	decoder.DisallowUnknownFields()
	err = decoder.Decode(&varSumoLogic)

	if err != nil {
		return err
	}

	*o = SumoLogic(varSumoLogic)
