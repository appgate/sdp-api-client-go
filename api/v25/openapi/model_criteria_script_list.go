...
// checks if the CriteriaScriptList type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &CriteriaScriptList{}
...
func (o CriteriaScriptList) ToMap() (map[string]interface{}, error) {
