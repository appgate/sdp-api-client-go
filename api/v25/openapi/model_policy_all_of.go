...
func (o *PolicyAllOf) GetBlockLocalDnsRequests() bool {
...
// and a boolean to check if the value has been set.
func (o *PolicyAllOf) GetBlockLocalDnsRequestsOk() (*bool, bool) {
	if o == nil || IsNil(o.BlockLocalDnsRequests) {
		return nil, false
	}
...
func (o *PolicyAllOf) HasBlockLocalDnsRequests() bool {
	if o != nil && !IsNil(o.BlockLocalDnsRequests) {
		return true
	}
...
func (o *PolicyAllOf) SetBlockLocalDnsRequests(v bool) {
