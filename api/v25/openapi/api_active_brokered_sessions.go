...
func (r ApiActiveBrokeredSessionsGetRequest) Query(query string) ApiActiveBrokeredSessionsGetRequest {
	r.query = &query
	return r
}
...
func (r ApiActiveBrokeredSessionsGetRequest) Range_(range_ string) ApiActiveBrokeredSessionsGetRequest {
	r.range_ = &range_
	return r
}
...
func (r ApiActiveBrokeredSessionsGetRequest) OrderBy(orderBy string) ApiActiveBrokeredSessionsGetRequest {
	r.orderBy = &orderBy
	return r
}

// Whether the sorting is applied descending or ascending. Defaults to certain field depending on the object type.
func (r ApiActiveBrokeredSessionsGetRequest) Descending(descending string) ApiActiveBrokeredSessionsGetRequest {
...
func (r ApiActiveBrokeredSessionsGetRequest) FilterBy(filterBy map[string]string) ApiActiveBrokeredSessionsGetRequest {
	r.filterBy = &filterBy
	return r
}

func (r ApiActiveBrokeredSessionsGetRequest) Execute() (*ActiveBrokeredSessionList, *http.Response, error) {
	return r.ApiService.ActiveBrokeredSessionsGetExecute(r)
}

/*
ActiveBrokeredSessionsGet Get Active Brokered Sessions.

Get a list of all Active Brokered Sessions from every Gateway in the system.
...
func (a *ActiveBrokeredSessionsAPIService) ActiveBrokeredSessionsGetExecute(r ApiActiveBrokeredSessionsGetRequest) (*ActiveBrokeredSessionList, *http.Response, error) {
	...
	localVarPath := localBasePath + "/active-brokered-sessions"
...
func (r ApiActiveBrokeredSessionsIdObserveGetRequest) GatewayId(gatewayId string) ApiActiveBrokeredSessionsIdObserveGetRequest {
	r.gatewayId = &gatewayId
	return r
}

// The distinguished name of the session owner. Returned by the list API.
func (r ApiActiveBrokeredSessionsIdObserveGetRequest) DistinguishedName(distinguishedName string) ApiActiveBrokeredSessionsIdObserveGetRequest {
...
/*
ActiveBrokeredSessionsIdObserveGet Observe an Active Brokered Session live.

Streams a live, read-only view of an Active Brokered Session as a sequence of Guacamole protocol frames. The response is a long-lived octet stream the client renders with a Guacamole static HTTP tunnel; it ends when the session ends or the client disconnects.
...
func (r ApiActiveBrokeredSessionsIdTerminatePostRequest) TerminateBrokeredSessionRequest(terminateBrokeredSessionRequest TerminateBrokeredSessionRequest) ApiActiveBrokeredSessionsIdTerminatePostRequest {
	r.terminateBrokeredSessionRequest = &terminateBrokeredSessionRequest
	return r
}

func (r ApiActiveBrokeredSessionsIdTerminatePostRequest) Execute() (*http.Response, error) {
	return r.ApiService.ActiveBrokeredSessionsIdTerminatePostExecute(r)
}

/*
ActiveBrokeredSessionsIdTerminatePost Terminate an Active Brokered Session.

Terminates an Active Brokered Session by its ID.
...
func (a *ActiveBrokeredSessionsAPIService) ActiveBrokeredSessionsIdTerminatePostExecute(r ApiActiveBrokeredSessionsIdTerminatePostRequest) (*http.Response, error) {
	...
	localVarQueryParams := url.Values{}
	localVarFormParams := url.Values{}
	if r.terminateBrokeredSessionRequest == nil {
		return nil, reportError("terminateBrokeredSessionRequest is required and must be specified")
	}
	...
	// body params
	localVarPostBody = r.terminateBrokeredSessionRequest
	req, err := a.client.prepareRequest(r.ctx, localVarPath, localVarHTTPMethod, localVarPostBody, localVarHeaderParams, localVarQueryParams, localVarFormParams, formFiles)
	if err != nil {
		return nil, err
	}
