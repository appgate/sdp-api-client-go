...
type _EntitlementScript EntitlementScript
...
func (o *EntitlementScript) GetReadOnly() bool {
...
// and a boolean to check if the value has been set.
func (o *EntitlementScript) GetReadOnlyOk() (*bool, bool) {
	if o == nil || IsNil(o.ReadOnly) {
		return nil, false
	}
...
func (o *EntitlementScript) HasReadOnly() bool {
	if o != nil && !IsNil(o.ReadOnly) {
		return true
	}
...
func (o *EntitlementScript) SetReadOnly(v bool) {
	o.ReadOnly = &v
}
...
func (o *EntitlementScript) UnmarshalJSON(data []byte) (err error) {
	...
	varEntitlementScript := _EntitlementScript{}

	decoder := json.NewDecoder(bytes.NewReader(data))
	decoder.DisallowUnknownFields()
	err = decoder.Decode(&varEntitlementScript)

	if err != nil {
		return err
	}

	*o = EntitlementScript(varEntitlementScript)
