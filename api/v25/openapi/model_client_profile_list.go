...
// checks if the ClientProfileList type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &ClientProfileList{}
...
// NewClientProfileList instantiates a new ClientProfileList object
// This constructor will assign default values to properties that have it defined,
// and makes sure properties required by API are set, but the set of arguments
// will change when the set of required properties is changed
func NewClientProfileList() *ClientProfileList {
	this := ClientProfileList{}
	return &this
}

// NewClientProfileListWithDefaults instantiates a new ClientProfileList object
...
func (o *ClientProfileList) GetTotalCount() int32 {
...
// and a boolean to check if the value has been set.
func (o *ClientProfileList) GetTotalCountOk() (*int32, bool) {
	if o == nil || IsNil(o.TotalCount) {
		return nil, false
	}
...
func (o *ClientProfileList) HasTotalCount() bool {
	if o != nil && !IsNil(o.TotalCount) {
		return true
	}
...
func (o *ClientProfileList) SetTotalCount(v int32) {
	o.TotalCount = &v
}
...
func (o *ClientProfileList) GetData() []map[string]interface{} {
...
// and a boolean to check if the value has been set.
func (o *ClientProfileList) GetDataOk() ([]map[string]interface{}, bool) {
	if o == nil || IsNil(o.Data) {
		return nil, false
	}
	return o.Data, true
...
func (o *ClientProfileList) SetData(v []map[string]interface{}) {
	o.Data = v
}
...
func (o ClientProfileList) ToMap() (map[string]interface{}, error) {
...
func NewNullableClientProfileList(val *ClientProfileList) *NullableClientProfileList {
	return &NullableClientProfileList{value: val, isSet: true}
}
