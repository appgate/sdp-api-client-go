...
type AdminMessagesSummarizeDataInner struct {
	...
	Metadata *AdminMessageMetadata `json:"metadata,omitempty"`
}
...
// SetMetadata gets a reference to the given AdminMessageMetadata and assigns it to the Metadata field.
func (o *AdminMessagesSummarizeDataInner) SetMetadata(v AdminMessageMetadata) {
	o.Metadata = &v
}
