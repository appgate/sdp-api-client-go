...
// NewRecordedSessionList instantiates a new RecordedSessionList object
// This constructor will assign default values to properties that have it defined,
// and makes sure properties required by API are set, but the set of arguments
// will change when the set of required properties is changed
func NewRecordedSessionList() *RecordedSessionList {
	this := RecordedSessionList{}
	return &this
}

// NewRecordedSessionListWithDefaults instantiates a new RecordedSessionList object
// This constructor will only assign default values to properties that have it defined,
// but it doesn't guarantee that properties required by API are set
func NewRecordedSessionListWithDefaults() *RecordedSessionList {
	this := RecordedSessionList{}
	return &this
}
...
func (o *RecordedSessionList) SetRange(v string) {
	o.Range = &v
}
...
func (o *RecordedSessionList) SetOrderBy(v string) {
	o.OrderBy = &v
}
...
func (o *RecordedSessionList) SetDescending(v bool) {
	o.Descending = &v
}
...
func (o *RecordedSessionList) SetQueries(v []string) {
	o.Queries = v
}
...
func (o *RecordedSessionList) SetTotalCount(v int32) {
	o.TotalCount = &v
}
...
func (o *RecordedSessionList) SetFilterBy(v []FilterBy) {
	o.FilterBy = v
}
...
func (o *RecordedSessionList) SetData(v []RecordedSession) {
	o.Data = v
}

// GetDiskUsage returns the DiskUsage field value if set, zero value otherwise (both if not set or set to explicit null).
func (o *RecordedSessionList) GetDiskUsage() RecordedSessionListAllOfDiskUsage {
...
func (o *RecordedSessionList) GetDiskUsageOk() (*RecordedSessionListAllOfDiskUsage, bool) {
	if o == nil {
		return nil, false
	}
...
func (o *RecordedSessionList) HasDiskUsage() bool {
...
func (o *RecordedSessionList) SetDiskUsage(v RecordedSessionListAllOfDiskUsage) {
	o.DiskUsage.Set(&v)
}

// SetDiskUsageNil sets the value for DiskUsage to be an explicit nil
func (o *RecordedSessionList) SetDiskUsageNil() {
	o.DiskUsage.Set(nil)
}

// UnsetDiskUsage ensures that no value is present for DiskUsage, not even an explicit nil
func (o *RecordedSessionList) UnsetDiskUsage() {
	o.DiskUsage.Unset()
}
...
type NullableRecordedSessionList struct {
	value *RecordedSessionList
	isSet bool
}

func (v NullableRecordedSessionList) Get() *RecordedSessionList {
	return v.value
}

func (v *NullableRecordedSessionList) Set(val *RecordedSessionList) {
	v.value = val
	v.isSet = true
}

func (v NullableRecordedSessionList) IsSet() bool {
	return v.isSet
}

func (v *NullableRecordedSessionList) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableRecordedSessionList(val *RecordedSessionList) *NullableRecordedSessionList {
	return &NullableRecordedSessionList{value: val, isSet: true}
}

func (v NullableRecordedSessionList) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableRecordedSessionList) UnmarshalJSON(src []byte) error {
	v.isSet = true
