...
type _ElasticsearchAllOfAuthentication ElasticsearchAllOfAuthentication
...
func (o *ElasticsearchAllOfAuthentication) UnmarshalJSON(data []byte) (err error) {
	...
	varElasticsearchAllOfAuthentication := _ElasticsearchAllOfAuthentication{}

	decoder := json.NewDecoder(bytes.NewReader(data))
	decoder.DisallowUnknownFields()
	err = decoder.Decode(&varElasticsearchAllOfAuthentication)

	if err != nil {
		return err
	}

	*o = ElasticsearchAllOfAuthentication(varElasticsearchAllOfAuthentication)
