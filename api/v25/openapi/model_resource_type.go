...
const (
	...
	LBSV2_TAGS                         ResourceType = "lbsv2-tags"
	LBSV2_TAG_VALUES                   ResourceType = "lbsv2-tag-values"
	...
	API_GATEWAYS                       ResourceType = "api-gateways"
	API_GATEWAYS_TAGS                  ResourceType = "api-gateways-tags"
	API_GATEWAYS_TAG_VALUES            ResourceType = "api-gateways-tag-values"
	API_GATEWAYS_V2                    ResourceType = "api-gateways-v2"
	API_GATEWAYS_V2_TAGS               ResourceType = "api-gateways-v2-tags"
	API_GATEWAYS_V2_TAG_VALUES         ResourceType = "api-gateways-v2-tag-values"
	EKS_CLUSTERS                       ResourceType = "eks-clusters"
	EKS_CLUSTERS_TAGS                  ResourceType = "eks-clusters-tags"
	EKS_CLUSTERS_TAG_VALUES            ResourceType = "eks-clusters-tag-values"
	RDS_DB_INSTANCES                   ResourceType = "rds-db-instances"
	RDS_DB_INSTANCES_TAGS              ResourceType = "rds-db-instances-tags"
	RDS_DB_INSTANCES_TAG_VALUES        ResourceType = "rds-db-instances-tag-values"
	ASSETS_TAGS                        ResourceType = "assets-tags"
	ASSETS_TAG_VALUES                  ResourceType = "assets-tag-values"
)
...
var AllowedResourceTypeEnumValues = []ResourceType{
	...
	"api-gateways",
	"api-gateways-tags",
	"api-gateways-tag-values",
	"api-gateways-v2",
	"api-gateways-v2-tags",
	"api-gateways-v2-tag-values",
	"eks-clusters",
	"eks-clusters-tags",
	"eks-clusters-tag-values",
	"rds-db-instances",
	"rds-db-instances-tags",
	"rds-db-instances-tag-values",
	"assets-tags",
	"assets-tag-values",
}
