...
type ApiPoliciesBulkUpsertPostRequest struct {
	ctx                           context.Context
	ApiService                    *PoliciesApiService
	policiesBulkUpsertPostRequest *PoliciesBulkUpsertPostRequest
}

// Bulk upsert request.
func (r ApiPoliciesBulkUpsertPostRequest) PoliciesBulkUpsertPostRequest(policiesBulkUpsertPostRequest PoliciesBulkUpsertPostRequest) ApiPoliciesBulkUpsertPostRequest {
	r.policiesBulkUpsertPostRequest = &policiesBulkUpsertPostRequest
	return r
}

func (r ApiPoliciesBulkUpsertPostRequest) Execute() (*BulkUpsertReport, *http.Response, error) {
	return r.ApiService.PoliciesBulkUpsertPostExecute(r)
}

/*
PoliciesBulkUpsertPost Bulk upsert Policies.

Create or update multiple policies in a single request.

	@param ctx context.Context - for authentication, logging, cancellation, deadlines, tracing, etc. Passed from http.Request or context.Background().
	@return ApiPoliciesBulkUpsertPostRequest
*/
func (a *PoliciesApiService) PoliciesBulkUpsertPost(ctx context.Context) ApiPoliciesBulkUpsertPostRequest {
	return ApiPoliciesBulkUpsertPostRequest{
		ApiService: a,
		ctx:        ctx,
	}
...
func (a *PoliciesApiService) PoliciesBulkUpsertPostExecute(r ApiPoliciesBulkUpsertPostRequest) (*BulkUpsertReport, *http.Response, error) {
	var (
	...
	localBasePath, err := a.client.cfg.ServerURLWithContext(r.ctx, "PoliciesApiService.PoliciesBulkUpsertPost")
	if err != nil {
		return localVarReturnValue, nil, &GenericOpenAPIError{error: err.Error()}
	}

	localVarPath := localBasePath + "/policies/bulk-upsert"

	localVarHeaderParams := make(map[string]string)
	localVarQueryParams := url.Values{}
	localVarFormParams := url.Values{}
	if r.policiesBulkUpsertPostRequest == nil {
		return localVarReturnValue, nil, reportError("policiesBulkUpsertPostRequest is required and must be specified")
	}
	...
	// body params
	localVarPostBody = r.policiesBulkUpsertPostRequest
