...
func (r ApiAuthenticationLogoutPostRequest) Execute() (*http.Response, error) {
	return r.ApiService.AuthenticationLogoutPostExecute(r)
}
...
func (a *LoginApiService) AuthenticationLogoutPostExecute(r ApiAuthenticationLogoutPostRequest) (*http.Response, error) {
	...
	localVarPath := localBasePath + "/authentication/logout"
...
func (r ApiAuthenticationOtpInitializePostRequest) AuthenticationOtpInitializePostRequest(authenticationOtpInitializePostRequest AuthenticationOtpInitializePostRequest) ApiAuthenticationOtpInitializePostRequest {
	r.authenticationOtpInitializePostRequest = &authenticationOtpInitializePostRequest
	return r
}
...
func (r ApiAuthenticationOtpPostRequest) AuthenticationOtpPostRequest(authenticationOtpPostRequest AuthenticationOtpPostRequest) ApiAuthenticationOtpPostRequest {
	r.authenticationOtpPostRequest = &authenticationOtpPostRequest
	return r
}
...
func (a *LoginApiService) AuthenticationOtpPostExecute(r ApiAuthenticationOtpPostRequest) (*LoginAuthenticationResponse, *http.Response, error) {
	...
	if localVarHTTPResponse.StatusCode >= 300 {
		...
		if localVarHTTPResponse.StatusCode == 401 {
			var v AuthenticationPost401Response
			err = a.client.decode(&v, localVarBody, localVarHTTPResponse.Header.Get("Content-Type"))
			if err != nil {
				newErr.error = err.Error()
				return localVarReturnValue, localVarHTTPResponse, newErr
