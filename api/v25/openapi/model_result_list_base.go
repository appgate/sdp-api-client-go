...
// checks if the ResultListBase type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &ResultListBase{}
...
func (o ResultListBase) ToMap() (map[string]interface{}, error) {
