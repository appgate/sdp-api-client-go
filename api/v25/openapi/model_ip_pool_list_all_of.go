...
// checks if the IpPoolListAllOf type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &IpPoolListAllOf{}
...
// NewIpPoolListAllOf instantiates a new IpPoolListAllOf object
// This constructor will assign default values to properties that have it defined,
// and makes sure properties required by API are set, but the set of arguments
// will change when the set of required properties is changed
func NewIpPoolListAllOf() *IpPoolListAllOf {
	this := IpPoolListAllOf{}
	return &this
}

// NewIpPoolListAllOfWithDefaults instantiates a new IpPoolListAllOf object
...
func (o IpPoolListAllOf) ToMap() (map[string]interface{}, error) {
...
func NewNullableIpPoolListAllOf(val *IpPoolListAllOf) *NullableIpPoolListAllOf {
	return &NullableIpPoolListAllOf{value: val, isSet: true}
}
