...
func (r ApiEntitlementsAppShortcutsGroupsGetRequest) Execute() (*GroupNamesList, *http.Response, error) {
	return r.ApiService.EntitlementsAppShortcutsGroupsGetExecute(r)
}

/*
EntitlementsAppShortcutsGroupsGet Get a list of group names.
...
func (a *EntitlementsApiService) EntitlementsAppShortcutsGroupsGetExecute(r ApiEntitlementsAppShortcutsGroupsGetRequest) (*GroupNamesList, *http.Response, error) {
	...
	localVarPath := localBasePath + "/entitlements/app-shortcuts/groups"
...
// Bulk upsert request.
func (r ApiEntitlementsBulkUpsertPostRequest) EntitlementsBulkUpsertPostRequest(entitlementsBulkUpsertPostRequest EntitlementsBulkUpsertPostRequest) ApiEntitlementsBulkUpsertPostRequest {
	r.entitlementsBulkUpsertPostRequest = &entitlementsBulkUpsertPostRequest
	return r
}

func (r ApiEntitlementsBulkUpsertPostRequest) Execute() (*BulkUpsertReport, *http.Response, error) {
	return r.ApiService.EntitlementsBulkUpsertPostExecute(r)
}

/*
EntitlementsBulkUpsertPost Bulk upsert Entitlements.

Create or update multiple entitlements in a single request.
...
func (a *EntitlementsApiService) EntitlementsBulkUpsertPostExecute(r ApiEntitlementsBulkUpsertPostRequest) (*BulkUpsertReport, *http.Response, error) {
	...
	localVarPath := localBasePath + "/entitlements/bulk-upsert"

	localVarHeaderParams := make(map[string]string)
	localVarQueryParams := url.Values{}
	localVarFormParams := url.Values{}
	if r.entitlementsBulkUpsertPostRequest == nil {
		return localVarReturnValue, nil, reportError("entitlementsBulkUpsertPostRequest is required and must be specified")
	}
	...
	// body params
	localVarPostBody = r.entitlementsBulkUpsertPostRequest
	req, err := a.client.prepareRequest(r.ctx, localVarPath, localVarHTTPMethod, localVarPostBody, localVarHeaderParams, localVarQueryParams, localVarFormParams, formFiles)
	if err != nil {
		return localVarReturnValue, nil, err
	}
...
func (r ApiEntitlementsCloudMigrationsPostRequest) DryRun(dryRun bool) ApiEntitlementsCloudMigrationsPostRequest {
	r.dryRun = &dryRun
	return r
}

func (r ApiEntitlementsCloudMigrationsPostRequest) Execute() (*EntitlementMigrationInfoList, *http.Response, error) {
	return r.ApiService.EntitlementsCloudMigrationsPostExecute(r)
}

/*
EntitlementsCloudMigrationsPost Migrate Entitlement host cloud resources in deprecated format to current format.
...
func (a *EntitlementsApiService) EntitlementsCloudMigrationsPostExecute(r ApiEntitlementsCloudMigrationsPostRequest) (*EntitlementMigrationInfoList, *http.Response, error) {
	...
	localVarPath := localBasePath + "/entitlements/cloud-migrations"
...
func (r ApiEntitlementsIdGetRequest) Execute() (*AnyEntitlement, *http.Response, error) {
...
func (a *EntitlementsApiService) EntitlementsIdGetExecute(r ApiEntitlementsIdGetRequest) (*AnyEntitlement, *http.Response, error) {
	var (
		localVarHTTPMethod  = http.MethodGet
		localVarPostBody    interface{}
		formFiles           []formFile
		localVarReturnValue *AnyEntitlement
	)
...
type ApiEntitlementsIdOptimizationGetRequest struct {
	ctx        context.Context
	ApiService *EntitlementsApiService
	id         string
}

func (r ApiEntitlementsIdOptimizationGetRequest) Execute() (*EntitlementOptimization, *http.Response, error) {
	return r.ApiService.EntitlementsIdOptimizationGetExecute(r)
}

/*
EntitlementsIdOptimizationGet Get optimization details for a specific Entitlement.

Returns optimization details for a specific Entitlement, including a suggested operation and suggested action removals based on usage data. Requires the Application Discovery licensed feature.

	@param ctx context.Context - for authentication, logging, cancellation, deadlines, tracing, etc. Passed from http.Request or context.Background().
	@param id ID of the object.
	@return ApiEntitlementsIdOptimizationGetRequest
*/
func (a *EntitlementsApiService) EntitlementsIdOptimizationGet(ctx context.Context, id string) ApiEntitlementsIdOptimizationGetRequest {
	return ApiEntitlementsIdOptimizationGetRequest{
		ApiService: a,
		ctx:        ctx,
		id:         id,
...
// Execute executes the request
//
//	@return EntitlementOptimization
func (a *EntitlementsApiService) EntitlementsIdOptimizationGetExecute(r ApiEntitlementsIdOptimizationGetRequest) (*EntitlementOptimization, *http.Response, error) {
	var (
		localVarHTTPMethod  = http.MethodGet
		localVarPostBody    interface{}
		formFiles           []formFile
		localVarReturnValue *EntitlementOptimization
	)

	localBasePath, err := a.client.cfg.ServerURLWithContext(r.ctx, "EntitlementsApiService.EntitlementsIdOptimizationGet")
	if err != nil {
		return localVarReturnValue, nil, &GenericOpenAPIError{error: err.Error()}
	}

	localVarPath := localBasePath + "/entitlements/{id}/optimization"
	localVarPath = strings.Replace(localVarPath, "{"+"id"+"}", url.PathEscape(parameterToString(r.id, "")), -1)
...
type ApiEntitlementsIdPutRequest struct {
	...
	ApiService     *EntitlementsApiService
	id             string
	anyEntitlement *AnyEntitlement
}

// Entitlement object. Use the &#x60;type&#x60; field to specify the entitlement type (Network, BrokeredRdp, BrokeredSsh).
func (r ApiEntitlementsIdPutRequest) AnyEntitlement(anyEntitlement AnyEntitlement) ApiEntitlementsIdPutRequest {
	r.anyEntitlement = &anyEntitlement
	return r
}

func (r ApiEntitlementsIdPutRequest) Execute() (*AnyEntitlement, *http.Response, error) {
...
//
//	@return AnyEntitlement
func (a *EntitlementsApiService) EntitlementsIdPutExecute(r ApiEntitlementsIdPutRequest) (*AnyEntitlement, *http.Response, error) {
	var (
	...
	localVarQueryParams := url.Values{}
	localVarFormParams := url.Values{}
	if r.anyEntitlement == nil {
		return localVarReturnValue, nil, reportError("anyEntitlement is required and must be specified")
	}
	...
	// body params
	localVarPostBody = r.anyEntitlement
	req, err := a.client.prepareRequest(r.ctx, localVarPath, localVarHTTPMethod, localVarPostBody, localVarHeaderParams, localVarQueryParams, localVarFormParams, formFiles)
	if err != nil {
		return localVarReturnValue, nil, err
	}
...
type ApiEntitlementsOptimizationStatsGetRequest struct {
	ctx        context.Context
	ApiService *EntitlementsApiService
}

func (r ApiEntitlementsOptimizationStatsGetRequest) Execute() (*EntitlementOptimizerStats, *http.Response, error) {
	return r.ApiService.EntitlementsOptimizationStatsGetExecute(r)
}

/*
EntitlementsOptimizationStatsGet Get aggregate optimization stats for all Entitlements.

Returns aggregate counts of Entitlements grouped by optimization score, used to power dashboard widgets. Requires the Application Discovery licensed feature.

	@param ctx context.Context - for authentication, logging, cancellation, deadlines, tracing, etc. Passed from http.Request or context.Background().
	@return ApiEntitlementsOptimizationStatsGetRequest
*/
func (a *EntitlementsApiService) EntitlementsOptimizationStatsGet(ctx context.Context) ApiEntitlementsOptimizationStatsGetRequest {
	return ApiEntitlementsOptimizationStatsGetRequest{
		ApiService: a,
		ctx:        ctx,
	}
...
// Execute executes the request
//
//	@return EntitlementOptimizerStats
func (a *EntitlementsApiService) EntitlementsOptimizationStatsGetExecute(r ApiEntitlementsOptimizationStatsGetRequest) (*EntitlementOptimizerStats, *http.Response, error) {
	var (
		localVarHTTPMethod  = http.MethodGet
		localVarPostBody    interface{}
		formFiles           []formFile
		localVarReturnValue *EntitlementOptimizerStats
	)

	localBasePath, err := a.client.cfg.ServerURLWithContext(r.ctx, "EntitlementsApiService.EntitlementsOptimizationStatsGet")
	if err != nil {
		return localVarReturnValue, nil, &GenericOpenAPIError{error: err.Error()}
	}

	localVarPath := localBasePath + "/entitlements/optimization/stats"
...
// Entitlement object. Use the &#x60;type&#x60; field to specify the entitlement type (Network, BrokeredRdp, BrokeredSsh).
func (r ApiEntitlementsPostRequest) AnyEntitlement(anyEntitlement AnyEntitlement) ApiEntitlementsPostRequest {
	r.anyEntitlement = &anyEntitlement
	return r
}

func (r ApiEntitlementsPostRequest) Execute() (*AnyEntitlement, *http.Response, error) {
...
//
//	@return AnyEntitlement
func (a *EntitlementsApiService) EntitlementsPostExecute(r ApiEntitlementsPostRequest) (*AnyEntitlement, *http.Response, error) {
	var (
		localVarHTTPMethod  = http.MethodPost
		localVarPostBody    interface{}
		formFiles           []formFile
