...
// checks if the SiteAllOf type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &SiteAllOf{}
...
func (o SiteAllOf) ToMap() (map[string]interface{}, error) {
