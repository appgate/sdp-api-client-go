...
// checks if the ServiceUserList type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &ServiceUserList{}
...
// NewServiceUserList instantiates a new ServiceUserList object
...
// NewServiceUserListWithDefaults instantiates a new ServiceUserList object
...
func (o *ServiceUserList) GetTotalCount() int32 {
...
// and a boolean to check if the value has been set.
func (o *ServiceUserList) GetTotalCountOk() (*int32, bool) {
	if o == nil || IsNil(o.TotalCount) {
		return nil, false
	}
...
func (o *ServiceUserList) HasTotalCount() bool {
	if o != nil && !IsNil(o.TotalCount) {
		return true
	}
...
func (o *ServiceUserList) SetTotalCount(v int32) {
	o.TotalCount = &v
}
...
func (o ServiceUserList) ToMap() (map[string]interface{}, error) {
...
func NewNullableServiceUserList(val *ServiceUserList) *NullableServiceUserList {
	return &NullableServiceUserList{value: val, isSet: true}
}
