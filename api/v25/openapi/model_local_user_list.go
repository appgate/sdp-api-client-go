...
// checks if the LocalUserList type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &LocalUserList{}
...
// NewLocalUserList instantiates a new LocalUserList object
...
// NewLocalUserListWithDefaults instantiates a new LocalUserList object
...
func (o *LocalUserList) GetTotalCount() int32 {
...
// and a boolean to check if the value has been set.
func (o *LocalUserList) GetTotalCountOk() (*int32, bool) {
	if o == nil || IsNil(o.TotalCount) {
		return nil, false
	}
...
func (o *LocalUserList) HasTotalCount() bool {
	if o != nil && !IsNil(o.TotalCount) {
		return true
	}
...
func (o *LocalUserList) SetTotalCount(v int32) {
	o.TotalCount = &v
}
...
func (o LocalUserList) ToMap() (map[string]interface{}, error) {
...
func NewNullableLocalUserList(val *LocalUserList) *NullableLocalUserList {
	return &NullableLocalUserList{value: val, isSet: true}
}
