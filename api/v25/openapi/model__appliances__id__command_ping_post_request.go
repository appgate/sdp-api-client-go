...
func NewAppliancesIdCommandPingPostRequest(destination string) *AppliancesIdCommandPingPostRequest {
	this := AppliancesIdCommandPingPostRequest{}
...
// NewAppliancesIdCommandPingPostRequestWithDefaults instantiates a new AppliancesIdCommandPingPostRequest object
...
func (o *AppliancesIdCommandPingPostRequest) SetProcessTimeout(v int32) {
	o.ProcessTimeout = &v
}
...
type NullableAppliancesIdCommandPingPostRequest struct {
	value *AppliancesIdCommandPingPostRequest
	isSet bool
}
...
func NewNullableAppliancesIdCommandPingPostRequest(val *AppliancesIdCommandPingPostRequest) *NullableAppliancesIdCommandPingPostRequest {
	return &NullableAppliancesIdCommandPingPostRequest{value: val, isSet: true}
}
