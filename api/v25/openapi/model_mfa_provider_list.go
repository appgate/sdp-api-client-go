...
// checks if the MfaProviderList type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &MfaProviderList{}
...
// NewMfaProviderList instantiates a new MfaProviderList object
...
// NewMfaProviderListWithDefaults instantiates a new MfaProviderList object
...
func (o *MfaProviderList) GetTotalCount() int32 {
...
// and a boolean to check if the value has been set.
func (o *MfaProviderList) GetTotalCountOk() (*int32, bool) {
	if o == nil || IsNil(o.TotalCount) {
		return nil, false
	}
...
func (o *MfaProviderList) HasTotalCount() bool {
	if o != nil && !IsNil(o.TotalCount) {
		return true
	}
...
func (o *MfaProviderList) SetTotalCount(v int32) {
	o.TotalCount = &v
}
...
func (o MfaProviderList) ToMap() (map[string]interface{}, error) {
...
func NewNullableMfaProviderList(val *MfaProviderList) *NullableMfaProviderList {
	return &NullableMfaProviderList{value: val, isSet: true}
}
