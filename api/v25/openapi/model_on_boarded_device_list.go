...
// checks if the OnBoardedDeviceList type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &OnBoardedDeviceList{}
...
func (o *OnBoardedDeviceList) GetTotalCount() int32 {
...
// and a boolean to check if the value has been set.
func (o *OnBoardedDeviceList) GetTotalCountOk() (*int32, bool) {
	if o == nil || IsNil(o.TotalCount) {
		return nil, false
	}
...
func (o *OnBoardedDeviceList) HasTotalCount() bool {
	if o != nil && !IsNil(o.TotalCount) {
		return true
	}
...
func (o *OnBoardedDeviceList) SetTotalCount(v int32) {
	o.TotalCount = &v
}
...
func (o OnBoardedDeviceList) ToMap() (map[string]interface{}, error) {
