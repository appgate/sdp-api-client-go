...
// checks if the DeviceScriptList type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &DeviceScriptList{}
...
// NewDeviceScriptList instantiates a new DeviceScriptList object
// This constructor will assign default values to properties that have it defined,
// and makes sure properties required by API are set, but the set of arguments
// will change when the set of required properties is changed
func NewDeviceScriptList() *DeviceScriptList {
	this := DeviceScriptList{}
	return &this
}

// NewDeviceScriptListWithDefaults instantiates a new DeviceScriptList object
...
func (o *DeviceScriptList) GetTotalCount() int32 {
...
// and a boolean to check if the value has been set.
func (o *DeviceScriptList) GetTotalCountOk() (*int32, bool) {
	if o == nil || IsNil(o.TotalCount) {
		return nil, false
	}
...
func (o *DeviceScriptList) HasTotalCount() bool {
	if o != nil && !IsNil(o.TotalCount) {
		return true
	}
...
func (o *DeviceScriptList) SetTotalCount(v int32) {
	o.TotalCount = &v
}
...
func (o DeviceScriptList) ToMap() (map[string]interface{}, error) {
...
func NewNullableDeviceScriptList(val *DeviceScriptList) *NullableDeviceScriptList {
	return &NullableDeviceScriptList{value: val, isSet: true}
}
