...
// NewRegistrationTokenWithDefaults instantiates a new RegistrationToken object
...
func (o *RegistrationToken) UnmarshalJSON(data []byte) (err error) {
	...
	err = decoder.Decode(&varRegistrationToken)
...
func NewNullableRegistrationToken(val *RegistrationToken) *NullableRegistrationToken {
	return &NullableRegistrationToken{value: val, isSet: true}
}
