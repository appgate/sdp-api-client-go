...
// checks if the TopGroups type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &TopGroups{}
...
func (o *TopGroups) GetTopGroupMembershipCounts() []TopGroupsTopGroupMembershipCountsInner {
	if o == nil || IsNil(o.TopGroupMembershipCounts) {
...
func (o TopGroups) ToMap() (map[string]interface{}, error) {
	toSerialize := map[string]interface{}{}
	if !IsNil(o.AppId) {
		toSerialize["appId"] = o.AppId
	}
	if !IsNil(o.TopGroupMembershipCounts) {
