...
// checks if the UserScriptList type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &UserScriptList{}
...
func (o *UserScriptList) GetTotalCount() int32 {
...
// and a boolean to check if the value has been set.
func (o *UserScriptList) GetTotalCountOk() (*int32, bool) {
	if o == nil || IsNil(o.TotalCount) {
		return nil, false
	}
...
func (o *UserScriptList) HasTotalCount() bool {
	if o != nil && !IsNil(o.TotalCount) {
		return true
	}
...
func (o *UserScriptList) SetTotalCount(v int32) {
	o.TotalCount = &v
}
...
func (o UserScriptList) ToMap() (map[string]interface{}, error) {
