...
// checks if the ApplianceAllOfNetworkingIpv6 type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &ApplianceAllOfNetworkingIpv6{}
...
func (o ApplianceAllOfNetworkingIpv6) ToMap() (map[string]interface{}, error) {
