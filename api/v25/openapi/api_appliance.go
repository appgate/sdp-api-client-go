...
func (r ApiAppliancesIdSwitchPartitionPostRequest) Execute() (*AppliancesRepartitionIpAllocationsPost202Response, *http.Response, error) {
	return r.ApiService.AppliancesIdSwitchPartitionPostExecute(r)
}
