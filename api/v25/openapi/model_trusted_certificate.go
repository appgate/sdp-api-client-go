...
func (o *TrustedCertificate) GetReadOnly() bool {
...
// and a boolean to check if the value has been set.
func (o *TrustedCertificate) GetReadOnlyOk() (*bool, bool) {
	if o == nil || o.ReadOnly == nil {
		return nil, false
	}
...
func (o *TrustedCertificate) HasReadOnly() bool {
	if o != nil && o.ReadOnly != nil {
		return true
	}
...
func (o *TrustedCertificate) SetReadOnly(v bool) {
	o.ReadOnly = &v
}
