...
type LdapCertificateProvider struct {
	...
	// Array of objects containing more detail about the certificates represented in caCertificates at matching index. This array is read only.
	CaCertificatesDetails []CertificateDetails `json:"caCertificatesDetails,omitempty"`
...
func (o *LdapCertificateProvider) SetReadOnly(v bool) {
	o.ReadOnly = &v
}
...
func (o *LdapCertificateProvider) GetCaCertificatesDetails() []CertificateDetails {
	...
	return o.CaCertificatesDetails
}
...
// SetCaCertificatesDetails gets a reference to the given []CertificateDetails and assigns it to the CaCertificatesDetails field.
func (o *LdapCertificateProvider) SetCaCertificatesDetails(v []CertificateDetails) {
	o.CaCertificatesDetails = v
}
