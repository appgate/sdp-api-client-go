...
// NewPolicyAllOfDnsSettingsWithDefaults instantiates a new PolicyAllOfDnsSettings object
...
func (o *PolicyAllOfDnsSettings) GetRegisterTunIpsToActiveDirectory() bool {
	...
	return *o.RegisterTunIpsToActiveDirectory
}
...
// SetRegisterTunIpsToActiveDirectory gets a reference to the given bool and assigns it to the RegisterTunIpsToActiveDirectory field.
func (o *PolicyAllOfDnsSettings) SetRegisterTunIpsToActiveDirectory(v bool) {
	o.RegisterTunIpsToActiveDirectory = &v
}
...
func NewNullablePolicyAllOfDnsSettings(val *PolicyAllOfDnsSettings) *NullablePolicyAllOfDnsSettings {
	return &NullablePolicyAllOfDnsSettings{value: val, isSet: true}
}
