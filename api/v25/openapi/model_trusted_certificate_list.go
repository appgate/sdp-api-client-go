...
// checks if the TrustedCertificateList type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &TrustedCertificateList{}
...
func (o *TrustedCertificateList) GetTotalCount() int32 {
...
// and a boolean to check if the value has been set.
func (o *TrustedCertificateList) GetTotalCountOk() (*int32, bool) {
	if o == nil || IsNil(o.TotalCount) {
		return nil, false
	}
...
func (o *TrustedCertificateList) HasTotalCount() bool {
	if o != nil && !IsNil(o.TotalCount) {
		return true
	}
...
func (o *TrustedCertificateList) SetTotalCount(v int32) {
	o.TotalCount = &v
}
...
func (o TrustedCertificateList) ToMap() (map[string]interface{}, error) {
