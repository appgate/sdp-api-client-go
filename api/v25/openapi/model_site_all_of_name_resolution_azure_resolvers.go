...
type _SiteAllOfNameResolutionAzureResolvers SiteAllOfNameResolutionAzureResolvers
...
func (o *SiteAllOfNameResolutionAzureResolvers) UnmarshalJSON(data []byte) (err error) {
	...
	varSiteAllOfNameResolutionAzureResolvers := _SiteAllOfNameResolutionAzureResolvers{}

	decoder := json.NewDecoder(bytes.NewReader(data))
	decoder.DisallowUnknownFields()
	err = decoder.Decode(&varSiteAllOfNameResolutionAzureResolvers)

	if err != nil {
		return err
	}

	*o = SiteAllOfNameResolutionAzureResolvers(varSiteAllOfNameResolutionAzureResolvers)
