...
// NewRecordingDiskUsage instantiates a new RecordingDiskUsage object
// This constructor will assign default values to properties that have it defined,
// and makes sure properties required by API are set, but the set of arguments
// will change when the set of required properties is changed
func NewRecordingDiskUsage() *RecordingDiskUsage {
	this := RecordingDiskUsage{}
	return &this
}

// NewRecordingDiskUsageWithDefaults instantiates a new RecordingDiskUsage object
// This constructor will only assign default values to properties that have it defined,
// but it doesn't guarantee that properties required by API are set
func NewRecordingDiskUsageWithDefaults() *RecordingDiskUsage {
	this := RecordingDiskUsage{}
	return &this
}
...
func (o *RecordingDiskUsage) SetTotalBytes(v int64) {
	o.TotalBytes = &v
}
...
func (o *RecordingDiskUsage) SetFreeBytes(v int64) {
	o.FreeBytes = &v
}
...
type NullableRecordingDiskUsage struct {
	value *RecordingDiskUsage
	isSet bool
}

func (v NullableRecordingDiskUsage) Get() *RecordingDiskUsage {
	return v.value
}

func (v *NullableRecordingDiskUsage) Set(val *RecordingDiskUsage) {
	v.value = val
	v.isSet = true
}

func (v NullableRecordingDiskUsage) IsSet() bool {
	return v.isSet
}

func (v *NullableRecordingDiskUsage) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableRecordingDiskUsage(val *RecordingDiskUsage) *NullableRecordingDiskUsage {
	return &NullableRecordingDiskUsage{value: val, isSet: true}
}

func (v NullableRecordingDiskUsage) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableRecordingDiskUsage) UnmarshalJSON(src []byte) error {
	v.isSet = true
