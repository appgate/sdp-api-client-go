...
// checks if the RadiusProviderAllOf type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &RadiusProviderAllOf{}
...
func (o RadiusProviderAllOf) ToMap() (map[string]interface{}, error) {
