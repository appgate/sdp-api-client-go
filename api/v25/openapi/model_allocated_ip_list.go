...
// checks if the AllocatedIpList type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &AllocatedIpList{}
...
func (o *AllocatedIpList) GetTotalCount() int32 {
...
// and a boolean to check if the value has been set.
func (o *AllocatedIpList) GetTotalCountOk() (*int32, bool) {
	if o == nil || IsNil(o.TotalCount) {
		return nil, false
	}
...
func (o *AllocatedIpList) HasTotalCount() bool {
	if o != nil && !IsNil(o.TotalCount) {
		return true
	}
...
func (o *AllocatedIpList) SetTotalCount(v int32) {
	o.TotalCount = &v
}
...
func (o AllocatedIpList) ToMap() (map[string]interface{}, error) {
