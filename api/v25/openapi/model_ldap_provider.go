...
func (o *LdapProvider) GetReadOnly() bool {
...
// and a boolean to check if the value has been set.
func (o *LdapProvider) GetReadOnlyOk() (*bool, bool) {
	if o == nil || IsNil(o.ReadOnly) {
		return nil, false
	}
...
func (o *LdapProvider) HasReadOnly() bool {
	if o != nil && !IsNil(o.ReadOnly) {
		return true
	}
...
func (o *LdapProvider) SetReadOnly(v bool) {
	o.ReadOnly = &v
}
...
func (o *LdapProvider) GetUserFilter() string {
...
// and a boolean to check if the value has been set.
func (o *LdapProvider) GetUserFilterOk() (*string, bool) {
	if o == nil || IsNil(o.UserFilter) {
		return nil, false
	}
...
func (o *LdapProvider) HasUserFilter() bool {
	if o != nil && !IsNil(o.UserFilter) {
		return true
	}
...
func (o *LdapProvider) SetUserFilter(v string) {
	o.UserFilter = &v
}
