...
func (r ApiHealthAppConnectivityGetRequest) Range_(range_ string) ApiHealthAppConnectivityGetRequest {
	r.range_ = &range_
	return r
}
...
func (r ApiHealthAppConnectivityGetRequest) OrderBy(orderBy string) ApiHealthAppConnectivityGetRequest {
	r.orderBy = &orderBy
	return r
}

// Whether the sorting is applied descending or ascending. Defaults to certain field depending on the object type.
func (r ApiHealthAppConnectivityGetRequest) Descending(descending string) ApiHealthAppConnectivityGetRequest {
...
func (r ApiHealthAppConnectivityGetRequest) FilterBy(filterBy map[string]string) ApiHealthAppConnectivityGetRequest {
	r.filterBy = &filterBy
	return r
}

func (r ApiHealthAppConnectivityGetRequest) Execute() (*UnhealthyAppList, *http.Response, error) {
	return r.ApiService.HealthAppConnectivityGetExecute(r)
}

/*
HealthAppConnectivityGet Get App Connectivity report.
...
func (a *HealthApiService) HealthAppConnectivityGetExecute(r ApiHealthAppConnectivityGetRequest) (*UnhealthyAppList, *http.Response, error) {
	...
	localVarPath := localBasePath + "/health/app-connectivity"
