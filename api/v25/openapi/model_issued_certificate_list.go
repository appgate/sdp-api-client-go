...
// checks if the IssuedCertificateList type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &IssuedCertificateList{}
...
// NewIssuedCertificateList instantiates a new IssuedCertificateList object
// This constructor will assign default values to properties that have it defined,
// and makes sure properties required by API are set, but the set of arguments
// will change when the set of required properties is changed
func NewIssuedCertificateList() *IssuedCertificateList {
	this := IssuedCertificateList{}
	return &this
}

// NewIssuedCertificateListWithDefaults instantiates a new IssuedCertificateList object
...
func (o *IssuedCertificateList) GetTotalCount() int32 {
...
// and a boolean to check if the value has been set.
func (o *IssuedCertificateList) GetTotalCountOk() (*int32, bool) {
	if o == nil || IsNil(o.TotalCount) {
		return nil, false
	}
...
func (o *IssuedCertificateList) HasTotalCount() bool {
	if o != nil && !IsNil(o.TotalCount) {
		return true
	}
...
func (o *IssuedCertificateList) SetTotalCount(v int32) {
	o.TotalCount = &v
}
...
func (o IssuedCertificateList) ToMap() (map[string]interface{}, error) {
...
func NewNullableIssuedCertificateList(val *IssuedCertificateList) *NullableIssuedCertificateList {
	return &NullableIssuedCertificateList{value: val, isSet: true}
}
