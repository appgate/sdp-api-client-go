...
// checks if the EntitlementScriptList type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &EntitlementScriptList{}
...
func (o *EntitlementScriptList) GetTotalCount() int32 {
...
// and a boolean to check if the value has been set.
func (o *EntitlementScriptList) GetTotalCountOk() (*int32, bool) {
	if o == nil || IsNil(o.TotalCount) {
		return nil, false
	}
...
func (o *EntitlementScriptList) HasTotalCount() bool {
	if o != nil && !IsNil(o.TotalCount) {
		return true
	}
...
func (o *EntitlementScriptList) SetTotalCount(v int32) {
	o.TotalCount = &v
}
...
func (o EntitlementScriptList) ToMap() (map[string]interface{}, error) {
