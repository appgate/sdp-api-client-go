...
Delete an Appliance Backup file from an Appliance. This API call must be made with **Accept** header of **application/vnd.appgate.peer-v25+gpg**.
...
func (r ApiAppliancesIdBackupBackupIdGetRequest) Range_(range_ string) ApiAppliancesIdBackupBackupIdGetRequest {
	r.range_ = &range_
	return r
}
...
Download a completed Appliance Backup with the given ID of an Appliance. This API call must be made with **Accept** header of **application/vnd.appgate.peer-v25+gpg** as it returns a GPG file as blob instead of JSON.
...
func (r ApiAppliancesIdBackupPostRequest) Execute() (*AppliancesIdBackupPost202Response, *http.Response, error) {
