...
type ApplianceAllOfClientInterface struct {
	...
	// Port to connect for the Clients that connect to Gateways on QUIC if enabled.
	DtlsPort *int32 `json:"dtlsPort,omitempty"`
	// Port to connect for STUN/TURN services.
	StunPort *int32 `json:"stunPort,omitempty"`
...
type _ApplianceAllOfClientInterface ApplianceAllOfClientInterface
...
// SetStunPort gets a reference to the given int32 and assigns it to the StunPort field.
func (o *ApplianceAllOfClientInterface) SetStunPort(v int32) {
	o.StunPort = &v
}
...
func (o *ApplianceAllOfClientInterface) UnmarshalJSON(data []byte) (err error) {
	...
	varApplianceAllOfClientInterface := _ApplianceAllOfClientInterface{}

	decoder := json.NewDecoder(bytes.NewReader(data))
	decoder.DisallowUnknownFields()
	err = decoder.Decode(&varApplianceAllOfClientInterface)

	if err != nil {
		return err
	}

	*o = ApplianceAllOfClientInterface(varApplianceAllOfClientInterface)
