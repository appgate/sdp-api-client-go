...
// checks if the UserLicenseList type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &UserLicenseList{}
...
// NewUserLicenseList instantiates a new UserLicenseList object
...
// NewUserLicenseListWithDefaults instantiates a new UserLicenseList object
...
func (o *UserLicenseList) GetTotalCount() int32 {
...
// and a boolean to check if the value has been set.
func (o *UserLicenseList) GetTotalCountOk() (*int32, bool) {
	if o == nil || IsNil(o.TotalCount) {
		return nil, false
	}
...
func (o *UserLicenseList) HasTotalCount() bool {
	if o != nil && !IsNil(o.TotalCount) {
		return true
	}
...
func (o *UserLicenseList) SetTotalCount(v int32) {
	o.TotalCount = &v
}
...
func (o UserLicenseList) ToMap() (map[string]interface{}, error) {
...
func NewNullableUserLicenseList(val *UserLicenseList) *NullableUserLicenseList {
	return &NullableUserLicenseList{value: val, isSet: true}
}
