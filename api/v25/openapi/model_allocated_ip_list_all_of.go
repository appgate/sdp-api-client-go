...
// checks if the AllocatedIpListAllOf type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &AllocatedIpListAllOf{}
...
func (o AllocatedIpListAllOf) ToMap() (map[string]interface{}, error) {
