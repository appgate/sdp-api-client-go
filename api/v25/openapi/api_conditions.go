...
type ApiConditionsBulkUpsertPostRequest struct {
	ctx                             context.Context
	ApiService                      *ConditionsApiService
	conditionsBulkUpsertPostRequest *ConditionsBulkUpsertPostRequest
}

// Bulk upsert request.
func (r ApiConditionsBulkUpsertPostRequest) ConditionsBulkUpsertPostRequest(conditionsBulkUpsertPostRequest ConditionsBulkUpsertPostRequest) ApiConditionsBulkUpsertPostRequest {
	r.conditionsBulkUpsertPostRequest = &conditionsBulkUpsertPostRequest
	return r
}

func (r ApiConditionsBulkUpsertPostRequest) Execute() (*BulkUpsertReport, *http.Response, error) {
	return r.ApiService.ConditionsBulkUpsertPostExecute(r)
}

/*
ConditionsBulkUpsertPost Bulk upsert Conditions.

Create or update multiple conditions in a single request.

	@param ctx context.Context - for authentication, logging, cancellation, deadlines, tracing, etc. Passed from http.Request or context.Background().
	@return ApiConditionsBulkUpsertPostRequest
*/
func (a *ConditionsApiService) ConditionsBulkUpsertPost(ctx context.Context) ApiConditionsBulkUpsertPostRequest {
	return ApiConditionsBulkUpsertPostRequest{
		ApiService: a,
		ctx:        ctx,
	}
...
func (a *ConditionsApiService) ConditionsBulkUpsertPostExecute(r ApiConditionsBulkUpsertPostRequest) (*BulkUpsertReport, *http.Response, error) {
	var (
	...
	localBasePath, err := a.client.cfg.ServerURLWithContext(r.ctx, "ConditionsApiService.ConditionsBulkUpsertPost")
	if err != nil {
		return localVarReturnValue, nil, &GenericOpenAPIError{error: err.Error()}
	}

	localVarPath := localBasePath + "/conditions/bulk-upsert"

	localVarHeaderParams := make(map[string]string)
	localVarQueryParams := url.Values{}
	localVarFormParams := url.Values{}
	if r.conditionsBulkUpsertPostRequest == nil {
		return localVarReturnValue, nil, reportError("conditionsBulkUpsertPostRequest is required and must be specified")
	}
	...
	// body params
	localVarPostBody = r.conditionsBulkUpsertPostRequest
	req, err := a.client.prepareRequest(r.ctx, localVarPath, localVarHTTPMethod, localVarPostBody, localVarHeaderParams, localVarQueryParams, localVarFormParams, formFiles)
	if err != nil {
		return localVarReturnValue, nil, err
	}
