...
func (r ApiAppliancesIdMetricsGetRequest) Execute() (string, *http.Response, error) {
	return r.ApiService.AppliancesIdMetricsGetExecute(r)
}

/*
AppliancesIdMetricsGet Get all the Prometheus metrics for an Appliance.

Get all the Prometheus metrics for the given Appliance. This API call must be made with **Accept** header of **application/vnd.appgate.peer-v25+text** as it returns plain text instead of JSON.
...
func (r ApiAppliancesIdMetricsNameGetRequest) Execute() (string, *http.Response, error) {
	return r.ApiService.AppliancesIdMetricsNameGetExecute(r)
}

/*
AppliancesIdMetricsNameGet Get a specific Prometheus metric for an Appliance.

Get a specific Prometheus metrics for the given Appliance. This API call must be made with **Accept** header of **application/vnd.appgate.peer-v25+text** as it returns plain text instead of JSON.
