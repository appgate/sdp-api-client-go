...
type Roles struct {
	...
	TelemetryAggregator   *ApplianceRole             `json:"telemetryAggregator,omitempty"`
...
// SetTelemetryAggregator gets a reference to the given ApplianceRole and assigns it to the TelemetryAggregator field.
func (o *Roles) SetTelemetryAggregator(v ApplianceRole) {
...
// SetConnectionBroker gets a reference to the given ConnectionBrokerRole and assigns it to the ConnectionBroker field.
func (o *Roles) SetConnectionBroker(v ConnectionBrokerRole) {
...
// SetGateway gets a reference to the given GatewayRole and assigns it to the Gateway field.
func (o *Roles) SetGateway(v GatewayRole) {
	o.Gateway = &v
}
