...
// checks if the IpPoolList type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &IpPoolList{}
...
func (o *IpPoolList) GetTotalCount() int32 {
...
// and a boolean to check if the value has been set.
func (o *IpPoolList) GetTotalCountOk() (*int32, bool) {
	if o == nil || IsNil(o.TotalCount) {
		return nil, false
	}
...
func (o *IpPoolList) HasTotalCount() bool {
	if o != nil && !IsNil(o.TotalCount) {
		return true
	}
...
func (o *IpPoolList) SetTotalCount(v int32) {
	o.TotalCount = &v
}
...
func (o IpPoolList) ToMap() (map[string]interface{}, error) {
