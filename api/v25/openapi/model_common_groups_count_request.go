...
type _CommonGroupsCountRequest CommonGroupsCountRequest
...
func (o *CommonGroupsCountRequest) UnmarshalJSON(data []byte) (err error) {
	...
	varCommonGroupsCountRequest := _CommonGroupsCountRequest{}

	decoder := json.NewDecoder(bytes.NewReader(data))
	decoder.DisallowUnknownFields()
	err = decoder.Decode(&varCommonGroupsCountRequest)

	if err != nil {
		return err
	}

	*o = CommonGroupsCountRequest(varCommonGroupsCountRequest)
