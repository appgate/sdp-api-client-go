...
type LicenseDetailsUsage struct {
	...
	// The amount of sites Connection Brokers are connected to.
	SitesConnectedViaBroker *float32                              `json:"sitesConnectedViaBroker,omitempty"`
...
func (o *LicenseDetailsUsage) GetSitesConnectedViaBroker() float32 {
	...
	return *o.SitesConnectedViaBroker
}
...
// SetSitesConnectedViaBroker gets a reference to the given float32 and assigns it to the SitesConnectedViaBroker field.
func (o *LicenseDetailsUsage) SetSitesConnectedViaBroker(v float32) {
	o.SitesConnectedViaBroker = &v
}
