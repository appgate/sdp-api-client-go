...
type TagDetails struct {
	...
	// Whether the tag is protected from manual updates and deletes.
...
func (o *TagDetails) GetReadOnly() bool {
...
// and a boolean to check if the value has been set.
func (o *TagDetails) GetReadOnlyOk() (*bool, bool) {
	if o == nil || IsNil(o.ReadOnly) {
		return nil, false
	}
...
func (o *TagDetails) HasReadOnly() bool {
	if o != nil && !IsNil(o.ReadOnly) {
		return true
	}
...
func (o *TagDetails) SetReadOnly(v bool) {
	o.ReadOnly = &v
}
