...
type _FilesPostRequest FilesPostRequest

// NewFilesPostRequest instantiates a new FilesPostRequest object
// This constructor will assign default values to properties that have it defined,
// and makes sure properties required by API are set, but the set of arguments
// will change when the set of required properties is changed
func NewFilesPostRequest(url string, filename string) *FilesPostRequest {
...
func (o *FilesPostRequest) GetUrl() string {
	if o == nil {
		var ret string
		return ret
	}
...
func (o *FilesPostRequest) GetUrlOk() (*string, bool) {
	if o == nil {
		return nil, false
	}
	return &o.Url, true
...
func (o *FilesPostRequest) SetUrl(v string) {
	o.Url = v
}

// GetFilename returns the Filename field value
func (o *FilesPostRequest) GetFilename() string {
	if o == nil {
		var ret string
		return ret
	}
...
// and a boolean to check if the value has been set.
func (o *FilesPostRequest) GetFilenameOk() (*string, bool) {
	if o == nil {
		return nil, false
	}
...
func (o *FilesPostRequest) SetFilename(v string) {
	o.Filename = v
}
...
func (o *FilesPostRequest) UnmarshalJSON(data []byte) (err error) {
	...
	varFilesPostRequest := _FilesPostRequest{}

	decoder := json.NewDecoder(bytes.NewReader(data))
	decoder.DisallowUnknownFields()
	err = decoder.Decode(&varFilesPostRequest)

	if err != nil {
		return err
	}

	*o = FilesPostRequest(varFilesPostRequest)
