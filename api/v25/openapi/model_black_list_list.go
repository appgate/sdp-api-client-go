...
// checks if the BlackListList type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &BlackListList{}
...
func (o BlackListList) ToMap() (map[string]interface{}, error) {
