...
type ApiSitesBulkUpsertPostRequest struct {
	ctx                        context.Context
	ApiService                 *SitesApiService
	sitesBulkUpsertPostRequest *SitesBulkUpsertPostRequest
}

// Bulk upsert request.
func (r ApiSitesBulkUpsertPostRequest) SitesBulkUpsertPostRequest(sitesBulkUpsertPostRequest SitesBulkUpsertPostRequest) ApiSitesBulkUpsertPostRequest {
	r.sitesBulkUpsertPostRequest = &sitesBulkUpsertPostRequest
	return r
}

func (r ApiSitesBulkUpsertPostRequest) Execute() (*BulkUpsertReport, *http.Response, error) {
	return r.ApiService.SitesBulkUpsertPostExecute(r)
}

/*
SitesBulkUpsertPost Bulk upsert Sites.

Create or update multiple sites in a single request.

	@param ctx context.Context - for authentication, logging, cancellation, deadlines, tracing, etc. Passed from http.Request or context.Background().
	@return ApiSitesBulkUpsertPostRequest
*/
func (a *SitesApiService) SitesBulkUpsertPost(ctx context.Context) ApiSitesBulkUpsertPostRequest {
	return ApiSitesBulkUpsertPostRequest{
		ApiService: a,
		ctx:        ctx,
	}
...
func (a *SitesApiService) SitesBulkUpsertPostExecute(r ApiSitesBulkUpsertPostRequest) (*BulkUpsertReport, *http.Response, error) {
	var (
	...
	localBasePath, err := a.client.cfg.ServerURLWithContext(r.ctx, "SitesApiService.SitesBulkUpsertPost")
	if err != nil {
		return localVarReturnValue, nil, &GenericOpenAPIError{error: err.Error()}
	}

	localVarPath := localBasePath + "/sites/bulk-upsert"

	localVarHeaderParams := make(map[string]string)
	localVarQueryParams := url.Values{}
	localVarFormParams := url.Values{}
	if r.sitesBulkUpsertPostRequest == nil {
		return localVarReturnValue, nil, reportError("sitesBulkUpsertPostRequest is required and must be specified")
	}
	...
	// body params
	localVarPostBody = r.sitesBulkUpsertPostRequest
...
func (r ApiSitesIdResourcesGetRequest) Resolver(resolver ResolverType) ApiSitesIdResourcesGetRequest {
	r.resolver = &resolver
	return r
}

// Resource type to query.
func (r ApiSitesIdResourcesGetRequest) Type_(type_ ResourceType) ApiSitesIdResourcesGetRequest {
	r.type_ = &type_
	return r
}
...
// &#39;Range string to limit the result list. Format: -. 3-10 means the items between the (including) 3rd and the 10th  will be returned. Defaults to all objects.&#39;
func (r ApiSitesIdResourcesGetRequest) Range_(range_ string) ApiSitesIdResourcesGetRequest {
	r.range_ = &range_
	return r
}
...
// &#39;Range string to limit the result list. Format: -. 3-10 means the items between the (including) 3rd and the 10th  will be returned. Defaults to all objects.&#39;
func (r ApiSitesStatusGetRequest) Range_(range_ string) ApiSitesStatusGetRequest {
	r.range_ = &range_
	return r
}

// The field name to sort the result list. Supported fields vary from object to object. Defaults to certain field depending on the object type.
func (r ApiSitesStatusGetRequest) OrderBy(orderBy string) ApiSitesStatusGetRequest {
	r.orderBy = &orderBy
	return r
}

// Whether the sorting is applied descending or ascending. Defaults to certain field depending on the object type.
func (r ApiSitesStatusGetRequest) Descending(descending string) ApiSitesStatusGetRequest {
	r.descending = &descending
	return r
}

// Filters the result list by the given field and value. Supported fields vary from API to API. The filters can be combined with each other as well as the generic query parameter. The given value is checked for inclusion.
func (r ApiSitesStatusGetRequest) FilterBy(filterBy map[string]string) ApiSitesStatusGetRequest {
	r.filterBy = &filterBy
	return r
}

func (r ApiSitesStatusGetRequest) Execute() (*SiteWithStatusList, *http.Response, error) {
	return r.ApiService.SitesStatusGetExecute(r)
}

/*
SitesStatusGet List all Sites with their health status.
...
func (a *SitesApiService) SitesStatusGetExecute(r ApiSitesStatusGetRequest) (*SiteWithStatusList, *http.Response, error) {
	...
	localVarPath := localBasePath + "/sites/status"
