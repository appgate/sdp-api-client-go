...
func (r ApiLicenseUsersDistinguishedNameDeleteRequest) Execute() (*_nethttp.Response, error) {
	return r.ApiService.LicenseUsersDistinguishedNameDeleteExecute(r)
}
 ...
 */
func (a *LicensedUsersApiService) LicenseUsersDistinguishedNameDeleteExecute(r ApiLicenseUsersDistinguishedNameDeleteRequest) (*_nethttp.Response, error) {
	var (
	...
	localBasePath, err := a.client.cfg.ServerURLWithContext(r.ctx, "LicensedUsersApiService.LicenseUsersDistinguishedNameDelete")
	if err != nil {
