...
func (r ApiDeviceScriptsDownloadIdGetRequest) Execute() (InlineResponse2008, *_nethttp.Response, error) {
	return r.ApiService.DeviceScriptsDownloadIdGetExecute(r)
}

/*
 * DeviceScriptsDownloadIdGet Download a Device Script.
 ...
 */
func (a *DeviceScriptsApiService) DeviceScriptsDownloadIdGetExecute(r ApiDeviceScriptsDownloadIdGetRequest) (InlineResponse2008, *_nethttp.Response, error) {
	var (
	...
	localBasePath, err := a.client.cfg.ServerURLWithContext(r.ctx, "DeviceScriptsApiService.DeviceScriptsDownloadIdGet")
	if err != nil {
...
/*
 * DeviceScriptsGet List all Device Scripts.
 ...
 */
func (a *DeviceScriptsApiService) DeviceScriptsGetExecute(r ApiDeviceScriptsGetRequest) (DeviceScriptList, *_nethttp.Response, error) {
	var (
		localVarHTTPMethod   = _nethttp.MethodGet
		localVarPostBody     interface{}
		localVarFormFileName string
	...
	localBasePath, err := a.client.cfg.ServerURLWithContext(r.ctx, "DeviceScriptsApiService.DeviceScriptsGet")
	if err != nil {
		return localVarReturnValue, nil, GenericOpenAPIError{error: err.Error()}
	}
...
/*
 * DeviceScriptsIdDelete Delete a specific Device Script.
 ...
 * Execute executes the request
 */
func (a *DeviceScriptsApiService) DeviceScriptsIdDeleteExecute(r ApiDeviceScriptsIdDeleteRequest) (*_nethttp.Response, error) {
	var (
	...
	localBasePath, err := a.client.cfg.ServerURLWithContext(r.ctx, "DeviceScriptsApiService.DeviceScriptsIdDelete")
	if err != nil {
...
/*
 * DeviceScriptsIdGet Get a specific Device Script.
 ...
 * @return DeviceScript
 */
func (a *DeviceScriptsApiService) DeviceScriptsIdGetExecute(r ApiDeviceScriptsIdGetRequest) (DeviceScript, *_nethttp.Response, error) {
	var (
		localVarHTTPMethod   = _nethttp.MethodGet
		localVarPostBody     interface{}
		localVarFormFileName string
	...
	localBasePath, err := a.client.cfg.ServerURLWithContext(r.ctx, "DeviceScriptsApiService.DeviceScriptsIdGet")
	if err != nil {
		return localVarReturnValue, nil, GenericOpenAPIError{error: err.Error()}
	}
...
/*
 * DeviceScriptsIdPut Update an existing Device Script.
 ...
 * @return DeviceScript
 */
func (a *DeviceScriptsApiService) DeviceScriptsIdPutExecute(r ApiDeviceScriptsIdPutRequest) (DeviceScript, *_nethttp.Response, error) {
	var (
	...
	localBasePath, err := a.client.cfg.ServerURLWithContext(r.ctx, "DeviceScriptsApiService.DeviceScriptsIdPut")
	if err != nil {
		return localVarReturnValue, nil, GenericOpenAPIError{error: err.Error()}
	}
...
/*
 * DeviceScriptsPost Create a new Device Script.
 ...
 * @return DeviceScript
 */
func (a *DeviceScriptsApiService) DeviceScriptsPostExecute(r ApiDeviceScriptsPostRequest) (DeviceScript, *_nethttp.Response, error) {
	var (
	...
	localBasePath, err := a.client.cfg.ServerURLWithContext(r.ctx, "DeviceScriptsApiService.DeviceScriptsPost")
	if err != nil {
		return localVarReturnValue, nil, GenericOpenAPIError{error: err.Error()}
	}
