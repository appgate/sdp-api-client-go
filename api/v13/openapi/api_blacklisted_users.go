 ...
 */
func (a *BlacklistedUsersApiService) BlacklistGetExecute(r ApiBlacklistGetRequest) (BlacklistEntry, *_nethttp.Response, error) {
	var (
 ...
 * @return BlacklistEntry
 */
func (a *BlacklistedUsersApiService) BlacklistPostExecute(r ApiBlacklistPostRequest) (BlacklistEntry, *_nethttp.Response, error) {
	var (
