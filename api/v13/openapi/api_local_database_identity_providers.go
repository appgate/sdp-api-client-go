...
func (r apiLocalDatabaseIdentityProvidersGetRequest) Execute() (LocalDatabaseIdentityProviderList, *_nethttp.Response, error) {
	...
	localBasePath, err := r.apiService.client.cfg.ServerURLWithContext(r.ctx, "LocalDatabaseIdentityProvidersApiService.IdentityProvidersGet")
	if err != nil {
	...
	if localVarHTTPResponse.StatusCode >= 300 {
		...
		if localVarHTTPResponse.StatusCode == 200 {
			var v LocalDatabaseIdentityProviderList
...
func (r apiLocalDatabaseIdentityProvidersIdAttributesPostRequest) InlineObject4(inlineObject4 InlineObject4) apiLocalDatabaseIdentityProvidersIdAttributesPostRequest {
...
*/
func (r apiLocalDatabaseIdentityProvidersIdAttributesPostRequest) Execute() (InlineResponse20010, *_nethttp.Response, error) {
	var (
	...
	localBasePath, err := r.apiService.client.cfg.ServerURLWithContext(r.ctx, "LocalDatabaseIdentityProvidersApiService.IdentityProvidersIdAttributesPost")
	if err != nil {
		return localVarReturnValue, nil, GenericOpenAPIError{error: err.Error()}
	}
...
func (r apiLocalDatabaseIdentityProvidersIdDeleteRequest) Execute() (*_nethttp.Response, error) {
	...
	localBasePath, err := r.apiService.client.cfg.ServerURLWithContext(r.ctx, "LocalDatabaseIdentityProvidersApiService.IdentityProvidersIdDelete")
	if err != nil {
...
func (r apiLocalDatabaseIdentityProvidersIdGetRequest) Execute() (LocalDatabaseProvider, *_nethttp.Response, error) {
	...
	localBasePath, err := r.apiService.client.cfg.ServerURLWithContext(r.ctx, "LocalDatabaseIdentityProvidersApiService.IdentityProvidersIdGet")
	if err != nil {
		return localVarReturnValue, nil, GenericOpenAPIError{error: err.Error()}
	}
...
func (r apiLocalDatabaseIdentityProvidersIdPutRequest) Execute() (LocalDatabaseProvider, *_nethttp.Response, error) {
	...
	localBasePath, err := r.apiService.client.cfg.ServerURLWithContext(r.ctx, "LocalDatabaseIdentityProvidersApiService.IdentityProvidersIdPut")
	if err != nil {
		return localVarReturnValue, nil, GenericOpenAPIError{error: err.Error()}
	}
...
func (r apiLocalDatabaseIdentityProvidersPostRequest) Execute() (LocalDatabaseProvider, *_nethttp.Response, error) {
	...
	localBasePath, err := r.apiService.client.cfg.ServerURLWithContext(r.ctx, "LocalDatabaseIdentityProvidersApiService.IdentityProvidersPost")
	if err != nil {
		return localVarReturnValue, nil, GenericOpenAPIError{error: err.Error()}
	}
...
*/
func (r apiLocalDatabaseIdentityProvidersTestPostRequest) Execute() (InlineResponse2009, *_nethttp.Response, error) {
	var (
		localVarHTTPMethod   = _nethttp.MethodPost
		localVarPostBody     interface{}
		localVarFormFileName string
	...
	localBasePath, err := r.apiService.client.cfg.ServerURLWithContext(r.ctx, "LocalDatabaseIdentityProvidersApiService.IdentityProvidersTestPost")
	if err != nil {
		return localVarReturnValue, nil, GenericOpenAPIError{error: err.Error()}
	}
