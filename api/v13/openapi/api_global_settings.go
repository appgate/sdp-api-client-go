...
func (r ApiGlobalSettingsBackupPassphraseDeleteRequest) Execute() (*_nethttp.Response, error) {
	return r.ApiService.GlobalSettingsBackupPassphraseDeleteExecute(r)
}
 ...
 */
func (a *GlobalSettingsApiService) GlobalSettingsBackupPassphraseDeleteExecute(r ApiGlobalSettingsBackupPassphraseDeleteRequest) (*_nethttp.Response, error) {
	var (
	...
	localBasePath, err := a.client.cfg.ServerURLWithContext(r.ctx, "GlobalSettingsApiService.GlobalSettingsBackupPassphraseDelete")
	if err != nil {
		return nil, GenericOpenAPIError{error: err.Error()}
	}

	localVarPath := localBasePath + "/global-settings-backup-passphrase"
