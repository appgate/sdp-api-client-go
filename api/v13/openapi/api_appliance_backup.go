...
func (r ApiAppliancesIdBackupBackupIdStatusGetRequest) Execute() (InlineResponse20014, *_nethttp.Response, error) {
 ...
 */
func (a *ApplianceBackupApiService) AppliancesIdBackupBackupIdStatusGetExecute(r ApiAppliancesIdBackupBackupIdStatusGetRequest) (InlineResponse20014, *_nethttp.Response, error) {
	var (
		localVarHTTPMethod   = _nethttp.MethodGet
		localVarPostBody     interface{}
		localVarFormFileName string
...
func (r ApiAppliancesIdBackupPostRequest) Execute() (InlineResponse20013, *_nethttp.Response, error) {
 ...
 */
func (a *ApplianceBackupApiService) AppliancesIdBackupPostExecute(r ApiAppliancesIdBackupPostRequest) (InlineResponse20013, *_nethttp.Response, error) {
	var (
