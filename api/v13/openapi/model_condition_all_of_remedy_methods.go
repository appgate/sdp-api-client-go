...
// NewConditionAllOfRemedyMethods instantiates a new ConditionAllOfRemedyMethods object
...
// NewConditionAllOfRemedyMethodsWithDefaults instantiates a new ConditionAllOfRemedyMethods object
...
type NullableConditionAllOfRemedyMethods struct {
	value *ConditionAllOfRemedyMethods
	isSet bool
}

func (v NullableConditionAllOfRemedyMethods) Get() *ConditionAllOfRemedyMethods {
	return v.value
}

func (v *NullableConditionAllOfRemedyMethods) Set(val *ConditionAllOfRemedyMethods) {
	v.value = val
	v.isSet = true
}

func (v NullableConditionAllOfRemedyMethods) IsSet() bool {
	return v.isSet
}

func (v *NullableConditionAllOfRemedyMethods) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableConditionAllOfRemedyMethods(val *ConditionAllOfRemedyMethods) *NullableConditionAllOfRemedyMethods {
	return &NullableConditionAllOfRemedyMethods{value: val, isSet: true}
}
