...
func NewAppliance(id string, name string, hostname string, clientInterface ApplianceAllOfClientInterface, peerInterface ApplianceAllOfPeerInterface, networking ApplianceAllOfNetworking) *Appliance {
	this := Appliance{}
	this.Id = id
	this.Name = name
