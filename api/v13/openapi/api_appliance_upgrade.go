...
func (r ApiAppliancesIdUpgradeGetRequest) Execute() (InlineResponse20012, *_nethttp.Response, error) {
 ...
 */
func (a *ApplianceUpgradeApiService) AppliancesIdUpgradeGetExecute(r ApiAppliancesIdUpgradeGetRequest) (InlineResponse20012, *_nethttp.Response, error) {
	var (
