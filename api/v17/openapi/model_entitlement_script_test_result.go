...
type EntitlementScriptTestResult struct {
	...
	Result *[]AnyOfstringAppShortcut `json:"result,omitempty"`
...
func (o *EntitlementScriptTestResult) GetResult() []AnyOfstringAppShortcut {
	if o == nil || o.Result == nil {
		var ret []AnyOfstringAppShortcut
		return ret
	}
	return *o.Result
}
...
func (o *EntitlementScriptTestResult) GetResultOk() (*[]AnyOfstringAppShortcut, bool) {
	if o == nil || o.Result == nil {
		return nil, false
	}
...
// SetResult gets a reference to the given []AnyOfstringAppShortcut and assigns it to the Result field.
func (o *EntitlementScriptTestResult) SetResult(v []AnyOfstringAppShortcut) {
	o.Result = &v
}
