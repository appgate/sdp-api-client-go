...
func (o *ConfigurableIdentityProviderAllOf) GetOnDemandClaimMappings() []map[string]interface{} {
...
// and a boolean to check if the value has been set.
func (o *ConfigurableIdentityProviderAllOf) GetOnDemandClaimMappingsOk() (*[]map[string]interface{}, bool) {
	if o == nil || o.OnDemandClaimMappings == nil {
		return nil, false
	}
...
func (o *ConfigurableIdentityProviderAllOf) SetOnDemandClaimMappings(v []map[string]interface{}) {
