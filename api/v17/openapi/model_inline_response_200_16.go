...
func (o *InlineResponse20016) GetRawAttributes() map[string][]string {
...
func (o *InlineResponse20016) GetRawAttributesOk() (*map[string][]string, bool) {
	if o == nil || o.RawAttributes == nil {
		return nil, false
	}
...
func (o *InlineResponse20016) HasRawAttributes() bool {
	if o != nil && o.RawAttributes != nil {
		return true
	}
...
func (o *InlineResponse20016) SetRawAttributes(v map[string][]string) {
	o.RawAttributes = &v
}

// GetMappedAttributes returns the MappedAttributes field value if set, zero value otherwise.
func (o *InlineResponse20016) GetMappedAttributes() map[string]string {
...
// and a boolean to check if the value has been set.
func (o *InlineResponse20016) GetMappedAttributesOk() (*map[string]string, bool) {
	if o == nil || o.MappedAttributes == nil {
		return nil, false
	}
...
func (o *InlineResponse20016) HasMappedAttributes() bool {
	if o != nil && o.MappedAttributes != nil {
		return true
	}
...
func (o *InlineResponse20016) SetMappedAttributes(v map[string]string) {
