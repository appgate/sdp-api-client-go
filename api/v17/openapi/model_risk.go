...
type Risk struct {
	...
	UserAction  *map[string]interface{} `json:"userAction,omitempty"`
}
...
func (o *Risk) GetUserAction() map[string]interface{} {
...
// and a boolean to check if the value has been set.
func (o *Risk) GetUserActionOk() (*map[string]interface{}, bool) {
	if o == nil || o.UserAction == nil {
		return nil, false
	}
...
// SetUserAction gets a reference to the given map[string]interface{} and assigns it to the UserAction field.
func (o *Risk) SetUserAction(v map[string]interface{}) {
	o.UserAction = &v
}
