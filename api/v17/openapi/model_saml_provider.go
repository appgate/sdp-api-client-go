...
func NewSamlProvider(id string, name string, type_ string, redirectUrl string, issuer string, audience string, providerCertificate string) *SamlProvider {
	this := SamlProvider{}
	this.Id = id
	this.Name = name
	this.Type = type_
...
func (o *SamlProvider) GetClaimMappings() []map[string]interface{} {
...
// and a boolean to check if the value has been set.
func (o *SamlProvider) GetClaimMappingsOk() (*[]map[string]interface{}, bool) {
	if o == nil || o.ClaimMappings == nil {
		return nil, false
	}
...
func (o *SamlProvider) SetClaimMappings(v []map[string]interface{}) {
	o.ClaimMappings = &v
}
...
func (o *SamlProvider) GetOnDemandClaimMappings() []map[string]interface{} {
...
// and a boolean to check if the value has been set.
func (o *SamlProvider) GetOnDemandClaimMappingsOk() (*[]map[string]interface{}, bool) {
	if o == nil || o.OnDemandClaimMappings == nil {
		return nil, false
	}
...
func (o *SamlProvider) SetOnDemandClaimMappings(v []map[string]interface{}) {
