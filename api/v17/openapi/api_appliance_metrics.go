...
func (r ApiAppliancesIdMetricsGetRequest) Execute() (string, *_nethttp.Response, error) {
...
Get all the Prometheus metrics for the given Appliance. This API call must be made with **Accept** header of **application/vnd.appgate.peer-v17+text** as it returns plain text instead of JSON.
...
//  @return string
func (a *ApplianceMetricsApiService) AppliancesIdMetricsGetExecute(r ApiAppliancesIdMetricsGetRequest) (string, *_nethttp.Response, error) {
	var (
...
func (r ApiAppliancesIdMetricsNameGetRequest) Execute() (string, *_nethttp.Response, error) {
...
Get a specific Prometheus metrics for the given Appliance. This API call must be made with **Accept** header of **application/vnd.appgate.peer-v17+text** as it returns plain text instead of JSON.
...
// Execute executes the request
//  @return string
func (a *ApplianceMetricsApiService) AppliancesIdMetricsNameGetExecute(r ApiAppliancesIdMetricsNameGetRequest) (string, *_nethttp.Response, error) {
	var (
		localVarHTTPMethod   = _nethttp.MethodGet
		localVarPostBody     interface{}
		localVarFormFileName string
