...
func (o *SessionInfoDistinguishedNameEntitlementInfos) GetConditionLogic() string {
...
func (o *SessionInfoDistinguishedNameEntitlementInfos) GetConditionLogicOk() (*string, bool) {
	if o == nil || o.ConditionLogic == nil {
		return nil, false
	}
...
func (o *SessionInfoDistinguishedNameEntitlementInfos) HasConditionLogic() bool {
	if o != nil && o.ConditionLogic != nil {
		return true
	}
...
func (o *SessionInfoDistinguishedNameEntitlementInfos) SetConditionLogic(v string) {
	o.ConditionLogic = &v
}
