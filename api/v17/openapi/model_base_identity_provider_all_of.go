...
func (o *BaseIdentityProviderAllOf) GetClaimMappings() []map[string]interface{} {
...
// and a boolean to check if the value has been set.
func (o *BaseIdentityProviderAllOf) GetClaimMappingsOk() (*[]map[string]interface{}, bool) {
	if o == nil || o.ClaimMappings == nil {
		return nil, false
	}
...
func (o *BaseIdentityProviderAllOf) SetClaimMappings(v []map[string]interface{}) {
	o.ClaimMappings = &v
}
