...
func (a *DeviceClaimScriptsApiService) DeviceScriptsDownloadIdGetExecute(r ApiDeviceScriptsDownloadIdGetRequest) (InlineResponse2008, *_nethttp.Response, error) {
	var (
