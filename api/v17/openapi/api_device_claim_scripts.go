...
func (r ApiDeviceScriptsDownloadIdGetRequest) Execute() (InlineResponse20013, *_nethttp.Response, error) {
...
func (a *DeviceClaimScriptsApiService) DeviceScriptsDownloadIdGetExecute(r ApiDeviceScriptsDownloadIdGetRequest) (InlineResponse20013, *_nethttp.Response, error) {
	var (
