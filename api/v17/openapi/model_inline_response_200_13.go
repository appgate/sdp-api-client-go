...
func (o *InlineResponse20013) GetFilename() string {
...
// and a boolean to check if the value has been set.
func (o *InlineResponse20013) GetFilenameOk() (*string, bool) {
	if o == nil || o.Filename == nil {
		return nil, false
	}
...
func (o *InlineResponse20013) HasFilename() bool {
	if o != nil && o.Filename != nil {
		return true
	}
...
func (o *InlineResponse20013) SetFilename(v string) {
	o.Filename = &v
}

// GetFile returns the File field value if set, zero value otherwise.
func (o *InlineResponse20013) GetFile() string {
	if o == nil || o.File == nil {
		var ret string
		return ret
	}
...
// and a boolean to check if the value has been set.
func (o *InlineResponse20013) GetFileOk() (*string, bool) {
	if o == nil || o.File == nil {
		return nil, false
	}
	return o.File, true
...
func (o *InlineResponse20013) HasFile() bool {
	if o != nil && o.File != nil {
		return true
	}
...
func (o *InlineResponse20013) SetFile(v string) {
	o.File = &v
}
