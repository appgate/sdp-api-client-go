...
// InlineResponse20014 Appliance Change information
...
func NewInlineResponse20014(id string, status string) *InlineResponse20014 {
...
func (o *InlineResponse20014) GetResult() string {
...
// and a boolean to check if the value has been set.
func (o *InlineResponse20014) GetResultOk() (*string, bool) {
	if o == nil || o.Result == nil {
		return nil, false
	}
...
func (o *InlineResponse20014) HasResult() bool {
	if o != nil && o.Result != nil {
		return true
	}
...
func (o *InlineResponse20014) SetResult(v string) {
	o.Result = &v
}
