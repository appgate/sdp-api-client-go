...
func NewOidcProvider(id string, name string, type_ string, issuer string, audience string) *OidcProvider {
	this := OidcProvider{}
	this.Id = id
	this.Name = name
	this.Type = type_
...
func (o *OidcProvider) GetClaimMappings() []map[string]interface{} {
...
// and a boolean to check if the value has been set.
func (o *OidcProvider) GetClaimMappingsOk() (*[]map[string]interface{}, bool) {
	if o == nil || o.ClaimMappings == nil {
		return nil, false
	}
...
func (o *OidcProvider) SetClaimMappings(v []map[string]interface{}) {
	o.ClaimMappings = &v
}
...
func (o *OidcProvider) GetOnDemandClaimMappings() []map[string]interface{} {
...
// and a boolean to check if the value has been set.
func (o *OidcProvider) GetOnDemandClaimMappingsOk() (*[]map[string]interface{}, bool) {
	if o == nil || o.OnDemandClaimMappings == nil {
		return nil, false
	}
...
func (o *OidcProvider) SetOnDemandClaimMappings(v []map[string]interface{}) {
