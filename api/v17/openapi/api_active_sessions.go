...
func (r ApiStatsActiveSessionsDnGetRequest) Execute() (ActiveSessionsDn, *_nethttp.Response, error) {
...
*/
func (a *ActiveSessionsApiService) StatsActiveSessionsDnGet(ctx _context.Context) ApiStatsActiveSessionsDnGetRequest {
	return ApiStatsActiveSessionsDnGetRequest{
		ApiService: a,
		ctx:        ctx,
	}
...
func (a *ActiveSessionsApiService) StatsActiveSessionsDnGetExecute(r ApiStatsActiveSessionsDnGetRequest) (ActiveSessionsDn, *_nethttp.Response, error) {
	var (
		localVarHTTPMethod   = _nethttp.MethodGet
		localVarPostBody     interface{}
		localVarFormFileName string
