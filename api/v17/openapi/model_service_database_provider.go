...
func NewServiceDatabaseProvider(id string, name string, type_ string) *ServiceDatabaseProvider {
...
func (o *ServiceDatabaseProvider) GetClaimMappings() []map[string]interface{} {
...
// and a boolean to check if the value has been set.
func (o *ServiceDatabaseProvider) GetClaimMappingsOk() (*[]map[string]interface{}, bool) {
	if o == nil || o.ClaimMappings == nil {
		return nil, false
	}
...
func (o *ServiceDatabaseProvider) SetClaimMappings(v []map[string]interface{}) {
	o.ClaimMappings = &v
}
