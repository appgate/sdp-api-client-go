...
func (r ApiClientProfilesIdBarcodeGetRequest) Execute() (*ClientConnectionsProfileNameBarcodeGet200Response, *http.Response, error) {
...
// Execute executes the request
//  @return ClientConnectionsProfileNameBarcodeGet200Response
func (a *ClientProfilesApiService) ClientProfilesIdBarcodeGetExecute(r ApiClientProfilesIdBarcodeGetRequest) (*ClientConnectionsProfileNameBarcodeGet200Response, *http.Response, error) {
	var (
		localVarHTTPMethod  = http.MethodGet
		localVarPostBody    interface{}
		formFiles           []formFile
