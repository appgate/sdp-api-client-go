...
func (r ApiConditionsTestPostRequest) Execute() (InlineResponse2002, *_nethttp.Response, error) {
...
func (a *ConditionsApiService) ConditionsTestPostExecute(r ApiConditionsTestPostRequest) (InlineResponse2002, *_nethttp.Response, error) {
	var (
		localVarHTTPMethod   = _nethttp.MethodPost
		localVarPostBody     interface{}
		localVarFormFileName string
