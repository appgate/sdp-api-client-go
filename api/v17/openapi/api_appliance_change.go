...
func (r ApiAppliancesIdChangeChangeIdGetRequest) Execute() (InlineResponse20014, *_nethttp.Response, error) {
...
func (a *ApplianceChangeApiService) AppliancesIdChangeChangeIdGetExecute(r ApiAppliancesIdChangeChangeIdGetRequest) (InlineResponse20014, *_nethttp.Response, error) {
	var (
	...
	localVarPath = strings.Replace(localVarPath, "{"+"changeId"+"}", _neturl.PathEscape(parameterToString(r.changeId, "")), -1)
