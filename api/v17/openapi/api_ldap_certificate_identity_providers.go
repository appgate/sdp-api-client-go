...
func (r ApiLdapCertificateIdentityProvidersGetRequest) Execute() (IdentityProviderList, *_nethttp.Response, error) {
...
func (a *LdapCertificateIdentityProvidersApiService) IdentityProvidersGetExecute(r ApiLdapCertificateIdentityProvidersGetRequest) (IdentityProviderList, *_nethttp.Response, error) {
	var (
...
func (r ApiLdapCertificateIdentityProvidersIdAttributesPostRequest) InlineObject14(inlineObject14 InlineObject14) ApiLdapCertificateIdentityProvidersIdAttributesPostRequest {
	r.inlineObject14 = &inlineObject14
	return r
}

func (r ApiLdapCertificateIdentityProvidersIdAttributesPostRequest) Execute() (InlineResponse20016, *_nethttp.Response, error) {
...
func (a *LdapCertificateIdentityProvidersApiService) IdentityProvidersIdAttributesPostExecute(r ApiLdapCertificateIdentityProvidersIdAttributesPostRequest) (InlineResponse20016, *_nethttp.Response, error) {
	var (
...
func (r ApiLdapCertificateIdentityProvidersIdGetRequest) Execute() (map[string]interface{}, *_nethttp.Response, error) {
...
func (a *LdapCertificateIdentityProvidersApiService) IdentityProvidersIdGetExecute(r ApiLdapCertificateIdentityProvidersIdGetRequest) (map[string]interface{}, *_nethttp.Response, error) {
	var (
		localVarHTTPMethod   = _nethttp.MethodGet
		localVarPostBody     interface{}
		localVarFormFileName string
...
func (r ApiLdapCertificateIdentityProvidersIdPutRequest) Body(body map[string]interface{}) ApiLdapCertificateIdentityProvidersIdPutRequest {
	r.body = &body
	return r
}

func (r ApiLdapCertificateIdentityProvidersIdPutRequest) Execute() (map[string]interface{}, *_nethttp.Response, error) {
...
// Execute executes the request
//  @return map[string]interface{}
func (a *LdapCertificateIdentityProvidersApiService) IdentityProvidersIdPutExecute(r ApiLdapCertificateIdentityProvidersIdPutRequest) (map[string]interface{}, *_nethttp.Response, error) {
	var (
...
// Identity Provider object.
func (r ApiLdapCertificateIdentityProvidersPostRequest) Body(body map[string]interface{}) ApiLdapCertificateIdentityProvidersPostRequest {
	r.body = &body
	return r
}

func (r ApiLdapCertificateIdentityProvidersPostRequest) Execute() (map[string]interface{}, *_nethttp.Response, error) {
...
// Execute executes the request
//  @return map[string]interface{}
func (a *LdapCertificateIdentityProvidersApiService) IdentityProvidersPostExecute(r ApiLdapCertificateIdentityProvidersPostRequest) (map[string]interface{}, *_nethttp.Response, error) {
	var (
		localVarHTTPMethod   = _nethttp.MethodPost
		localVarPostBody     interface{}
		localVarFormFileName string
...
func (r ApiLdapCertificateIdentityProvidersTestPostRequest) Execute() (InlineResponse20015, *_nethttp.Response, error) {
...
func (a *LdapCertificateIdentityProvidersApiService) IdentityProvidersTestPostExecute(r ApiLdapCertificateIdentityProvidersTestPostRequest) (InlineResponse20015, *_nethttp.Response, error) {
	var (
		localVarHTTPMethod   = _nethttp.MethodPost
		localVarPostBody     interface{}
		localVarFormFileName string
