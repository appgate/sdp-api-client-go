...
func (r ApiAppliancesIdUpgradeCompletePostRequest) InlineObject11(inlineObject11 InlineObject11) ApiAppliancesIdUpgradeCompletePostRequest {
...
func (r ApiAppliancesIdUpgradeGetRequest) Execute() (InlineResponse20015, *_nethttp.Response, error) {
...
func (a *ApplianceUpgradeApiService) AppliancesIdUpgradeGetExecute(r ApiAppliancesIdUpgradeGetRequest) (InlineResponse20015, *_nethttp.Response, error) {
	var (
...
func (r ApiFilesPostRequest) InlineObject13(inlineObject13 InlineObject13) ApiFilesPostRequest {
