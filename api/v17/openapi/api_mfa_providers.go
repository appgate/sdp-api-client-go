...
func (r ApiMfaProvidersTestPostRequest) Execute() (InlineResponse20015, *_nethttp.Response, error) {
...
func (a *MFAProvidersApiService) MfaProvidersTestPostExecute(r ApiMfaProvidersTestPostRequest) (InlineResponse20015, *_nethttp.Response, error) {
	var (
		localVarHTTPMethod   = _nethttp.MethodPost
		localVarPostBody     interface{}
		localVarFormFileName string
