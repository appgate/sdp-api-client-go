...
func NewInlineObject7(otp string) *InlineObject7 {
	this := InlineObject7{}
	this.Otp = otp
	return &this
}
...
func (o *InlineObject7) GetOtp() string {
	if o == nil {
		var ret string
		return ret
	}
...
func (o *InlineObject7) GetOtpOk() (*string, bool) {
	if o == nil {
		return nil, false
	}
	return &o.Otp, true
...
func (o *InlineObject7) SetOtp(v string) {
	o.Otp = v
}

// GetState returns the State field value if set, zero value otherwise.
func (o *InlineObject7) GetState() string {
...
// and a boolean to check if the value has been set.
func (o *InlineObject7) GetStateOk() (*string, bool) {
	if o == nil || o.State == nil {
		return nil, false
	}
	return o.State, true
...
func (o *InlineObject7) HasState() bool {
	if o != nil && o.State != nil {
		return true
	}
...
func (o *InlineObject7) SetState(v string) {
	o.State = &v
}
