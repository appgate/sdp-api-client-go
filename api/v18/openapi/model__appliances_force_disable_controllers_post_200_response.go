...
type AppliancesForceDisableControllersPost200Response struct {
	...
	OfflineApplianes []string `json:"offlineApplianes,omitempty"`
}
...
// GetOfflineApplianes returns the OfflineApplianes field value if set, zero value otherwise.
func (o *AppliancesForceDisableControllersPost200Response) GetOfflineApplianes() []string {
	if o == nil || o.OfflineApplianes == nil {
		var ret []string
		return ret
	}
	return o.OfflineApplianes
}

// GetOfflineApplianesOk returns a tuple with the OfflineApplianes field value if set, nil otherwise
// and a boolean to check if the value has been set.
func (o *AppliancesForceDisableControllersPost200Response) GetOfflineApplianesOk() ([]string, bool) {
	if o == nil || o.OfflineApplianes == nil {
		return nil, false
	}
	return o.OfflineApplianes, true
}

// HasOfflineApplianes returns a boolean if a field has been set.
func (o *AppliancesForceDisableControllersPost200Response) HasOfflineApplianes() bool {
	if o != nil && o.OfflineApplianes != nil {
		return true
	}
...
// SetOfflineApplianes gets a reference to the given []string and assigns it to the OfflineApplianes field.
func (o *AppliancesForceDisableControllersPost200Response) SetOfflineApplianes(v []string) {
	o.OfflineApplianes = v
}

func (o AppliancesForceDisableControllersPost200Response) MarshalJSON() ([]byte, error) {
	toSerialize := map[string]interface{}{}
	if o.OfflineApplianes != nil {
		toSerialize["offlineApplianes"] = o.OfflineApplianes
	}
