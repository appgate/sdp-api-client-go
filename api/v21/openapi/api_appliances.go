...
Runs ICMP ping command on an Appliance. This API call must be made with **Accept** header of **application/vnd.appgate.peer-v21+text** as it returns plain text instead of JSON.
...
Runs tcpdump command on an Appliance. This API call must be made with **Accept** header of **application/vnd.appgate.peer-v21+text** as it returns plain text instead of JSON.
