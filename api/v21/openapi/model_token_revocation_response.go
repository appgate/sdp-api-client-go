...
// checks if the TokenRevocationResponse type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &TokenRevocationResponse{}
...
// NewTokenRevocationResponse instantiates a new TokenRevocationResponse object
// This constructor will assign default values to properties that have it defined,
// and makes sure properties required by API are set, but the set of arguments
// will change when the set of required properties is changed
func NewTokenRevocationResponse() *TokenRevocationResponse {
	this := TokenRevocationResponse{}
	return &this
}

// NewTokenRevocationResponseWithDefaults instantiates a new TokenRevocationResponse object
...
func (o *TokenRevocationResponse) GetTotalCount() int32 {
...
// and a boolean to check if the value has been set.
func (o *TokenRevocationResponse) GetTotalCountOk() (*int32, bool) {
	if o == nil || IsNil(o.TotalCount) {
		return nil, false
	}
...
func (o *TokenRevocationResponse) HasTotalCount() bool {
	if o != nil && !IsNil(o.TotalCount) {
		return true
	}
...
func (o *TokenRevocationResponse) SetTotalCount(v int32) {
	o.TotalCount = &v
}
...
func (o TokenRevocationResponse) ToMap() (map[string]interface{}, error) {
...
func NewNullableTokenRevocationResponse(val *TokenRevocationResponse) *NullableTokenRevocationResponse {
	return &NullableTokenRevocationResponse{value: val, isSet: true}
}
