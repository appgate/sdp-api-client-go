...
// checks if the DistinguishedNameList type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &DistinguishedNameList{}
...
// NewDistinguishedNameList instantiates a new DistinguishedNameList object
// This constructor will assign default values to properties that have it defined,
// and makes sure properties required by API are set, but the set of arguments
// will change when the set of required properties is changed
func NewDistinguishedNameList() *DistinguishedNameList {
	this := DistinguishedNameList{}
	return &this
}

// NewDistinguishedNameListWithDefaults instantiates a new DistinguishedNameList object
...
func (o *DistinguishedNameList) GetTotalCount() int32 {
...
// and a boolean to check if the value has been set.
func (o *DistinguishedNameList) GetTotalCountOk() (*int32, bool) {
	if o == nil || IsNil(o.TotalCount) {
		return nil, false
	}
...
func (o *DistinguishedNameList) HasTotalCount() bool {
	if o != nil && !IsNil(o.TotalCount) {
		return true
	}
...
func (o *DistinguishedNameList) SetTotalCount(v int32) {
	o.TotalCount = &v
}
...
func (o DistinguishedNameList) ToMap() (map[string]interface{}, error) {
...
func NewNullableDistinguishedNameList(val *DistinguishedNameList) *NullableDistinguishedNameList {
	return &NullableDistinguishedNameList{value: val, isSet: true}
}
