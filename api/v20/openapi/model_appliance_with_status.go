...
func (o *ApplianceWithStatus) GetDetails() map[string]interface{} {
...
// and a boolean to check if the value has been set.
func (o *ApplianceWithStatus) GetDetailsOk() (*map[string]interface{}, bool) {
	if o == nil || o.Details == nil {
		return nil, false
	}
...
func (o *ApplianceWithStatus) SetDetails(v map[string]interface{}) {
	o.Details = &v
}
