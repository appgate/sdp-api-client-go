...
// checks if the OnBoardedDevicesAllOf type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &OnBoardedDevicesAllOf{}
...
// NewOnBoardedDevicesAllOf instantiates a new OnBoardedDevicesAllOf object
// This constructor will assign default values to properties that have it defined,
// and makes sure properties required by API are set, but the set of arguments
// will change when the set of required properties is changed
func NewOnBoardedDevicesAllOf() *OnBoardedDevicesAllOf {
	this := OnBoardedDevicesAllOf{}
	return &this
}

// NewOnBoardedDevicesAllOfWithDefaults instantiates a new OnBoardedDevicesAllOf object
...
func (o OnBoardedDevicesAllOf) ToMap() (map[string]interface{}, error) {
...
func NewNullableOnBoardedDevicesAllOf(val *OnBoardedDevicesAllOf) *NullableOnBoardedDevicesAllOf {
	return &NullableOnBoardedDevicesAllOf{value: val, isSet: true}
}
