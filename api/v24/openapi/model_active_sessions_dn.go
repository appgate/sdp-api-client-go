...
// checks if the ActiveSessionsDn type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &ActiveSessionsDn{}
...
type ActiveSessionsDn struct {
	...
	Data             []ActiveSessionsDnAllOfData `json:"data,omitempty"`
...
func NewActiveSessionsDn() *ActiveSessionsDn {
	this := ActiveSessionsDn{}
	return &this
}

// NewActiveSessionsDnWithDefaults instantiates a new ActiveSessionsDn object
...
func (o *ActiveSessionsDn) GetTotalCount() int32 {
...
// and a boolean to check if the value has been set.
func (o *ActiveSessionsDn) GetTotalCountOk() (*int32, bool) {
	if o == nil || IsNil(o.TotalCount) {
		return nil, false
	}
...
func (o *ActiveSessionsDn) HasTotalCount() bool {
	if o != nil && !IsNil(o.TotalCount) {
		return true
	}
...
func (o *ActiveSessionsDn) SetTotalCount(v int32) {
	o.TotalCount = &v
}
...
func (o *ActiveSessionsDn) GetData() []ActiveSessionsDnAllOfData {
	if o == nil || IsNil(o.Data) {
		var ret []ActiveSessionsDnAllOfData
		return ret
	}
	return o.Data
}
...
// and a boolean to check if the value has been set.
func (o *ActiveSessionsDn) GetDataOk() ([]ActiveSessionsDnAllOfData, bool) {
	if o == nil || IsNil(o.Data) {
		return nil, false
	}
	return o.Data, true
...
// SetData gets a reference to the given []ActiveSessionsDnAllOfData and assigns it to the Data field.
func (o *ActiveSessionsDn) SetData(v []ActiveSessionsDnAllOfData) {
	o.Data = v
}

// GetGeolocationQuery returns the GeolocationQuery field value if set, zero value otherwise.
func (o *ActiveSessionsDn) GetGeolocationQuery() GeolocationQuery {
...
// and a boolean to check if the value has been set.
func (o *ActiveSessionsDn) GetGeolocationQueryOk() (*GeolocationQuery, bool) {
	if o == nil || IsNil(o.GeolocationQuery) {
		return nil, false
	}
...
func (o *ActiveSessionsDn) HasGeolocationQuery() bool {
	if o != nil && !IsNil(o.GeolocationQuery) {
		return true
	}
...
func (o *ActiveSessionsDn) SetGeolocationQuery(v GeolocationQuery) {
...
func (o ActiveSessionsDn) ToMap() (map[string]interface{}, error) {
...
func NewNullableActiveSessionsDn(val *ActiveSessionsDn) *NullableActiveSessionsDn {
	return &NullableActiveSessionsDn{value: val, isSet: true}
}
