...
// checks if the BaseActiveSession type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &BaseActiveSession{}
...
func (o BaseActiveSession) ToMap() (map[string]interface{}, error) {
