...
func (o *License) SetMaxAccessPolicies(v float32) {
...
func (o *License) SetRiskEngine(v bool) {
	o.RiskEngine = &v
}
...
func (o *License) SetCollectiveReplication(v bool) {
...
func (o *License) SetVerifiedDnsNames(v LicenseEntitlementVerifiedDnsNames) {
