...
type LicenseEntitlement struct {
	...
	MaxAccessPolicies *float32 `json:"maxAccessPolicies,omitempty"`
	...
	// Whether the Collective Replication feature is enabled.
	CollectiveReplication *bool                               `json:"collectiveReplication,omitempty"`
	VerifiedDnsNames      *LicenseEntitlementVerifiedDnsNames `json:"verifiedDnsNames,omitempty"`
}
...
func (o *LicenseEntitlement) GetMaxAccessPolicies() float32 {
	if o == nil || o.MaxAccessPolicies == nil {
		var ret float32
		return ret
	}
	return *o.MaxAccessPolicies
}

// GetMaxAccessPoliciesOk returns a tuple with the MaxAccessPolicies field value if set, nil otherwise
// and a boolean to check if the value has been set.
func (o *LicenseEntitlement) GetMaxAccessPoliciesOk() (*float32, bool) {
	if o == nil || o.MaxAccessPolicies == nil {
		return nil, false
	}
...
func (o *LicenseEntitlement) HasMaxAccessPolicies() bool {
	if o != nil && o.MaxAccessPolicies != nil {
		return true
	}
...
// SetMaxAccessPolicies gets a reference to the given float32 and assigns it to the MaxAccessPolicies field.
func (o *LicenseEntitlement) SetMaxAccessPolicies(v float32) {
	o.MaxAccessPolicies = &v
}
...
func (o *LicenseEntitlement) GetApplicationDiscovery() bool {
...
// and a boolean to check if the value has been set.
func (o *LicenseEntitlement) GetApplicationDiscoveryOk() (*bool, bool) {
	if o == nil || o.ApplicationDiscovery == nil {
		return nil, false
	}
...
func (o *LicenseEntitlement) HasApplicationDiscovery() bool {
	if o != nil && o.ApplicationDiscovery != nil {
		return true
	}
...
func (o *LicenseEntitlement) SetApplicationDiscovery(v bool) {
...
func (o *LicenseEntitlement) GetDigitalExperienceMonitoring() bool {
...
// and a boolean to check if the value has been set.
func (o *LicenseEntitlement) GetDigitalExperienceMonitoringOk() (*bool, bool) {
	if o == nil || o.DigitalExperienceMonitoring == nil {
		return nil, false
	}
...
func (o *LicenseEntitlement) HasDigitalExperienceMonitoring() bool {
	if o != nil && o.DigitalExperienceMonitoring != nil {
		return true
	}
...
func (o *LicenseEntitlement) SetDigitalExperienceMonitoring(v bool) {
...
func (o *LicenseEntitlement) GetCollectiveReplication() bool {
...
// and a boolean to check if the value has been set.
func (o *LicenseEntitlement) GetCollectiveReplicationOk() (*bool, bool) {
	if o == nil || o.CollectiveReplication == nil {
		return nil, false
	}
...
func (o *LicenseEntitlement) HasCollectiveReplication() bool {
	if o != nil && o.CollectiveReplication != nil {
		return true
	}
...
// SetCollectiveReplication gets a reference to the given bool and assigns it to the CollectiveReplication field.
func (o *LicenseEntitlement) SetCollectiveReplication(v bool) {
	o.CollectiveReplication = &v
}

// GetVerifiedDnsNames returns the VerifiedDnsNames field value if set, zero value otherwise.
func (o *LicenseEntitlement) GetVerifiedDnsNames() LicenseEntitlementVerifiedDnsNames {
	if o == nil || o.VerifiedDnsNames == nil {
		var ret LicenseEntitlementVerifiedDnsNames
		return ret
	}
	return *o.VerifiedDnsNames
}

// GetVerifiedDnsNamesOk returns a tuple with the VerifiedDnsNames field value if set, nil otherwise
// and a boolean to check if the value has been set.
func (o *LicenseEntitlement) GetVerifiedDnsNamesOk() (*LicenseEntitlementVerifiedDnsNames, bool) {
	if o == nil || o.VerifiedDnsNames == nil {
		return nil, false
	}
...
func (o *LicenseEntitlement) HasVerifiedDnsNames() bool {
	if o != nil && o.VerifiedDnsNames != nil {
		return true
	}
...
// SetVerifiedDnsNames gets a reference to the given LicenseEntitlementVerifiedDnsNames and assigns it to the VerifiedDnsNames field.
func (o *LicenseEntitlement) SetVerifiedDnsNames(v LicenseEntitlementVerifiedDnsNames) {
	o.VerifiedDnsNames = &v
}
