...
func (r ApiRiskModelGetRequest) Execute() (*RiskModel, *http.Response, error) {
	return r.ApiService.RiskModelGetExecute(r)
}

/*
RiskModelGet View the current Risk Model.

View the current Risk Model. Deprecated as of 6.5. Please use Conditions instead.
...
func (a *RiskModelApiService) RiskModelGetExecute(r ApiRiskModelGetRequest) (*RiskModel, *http.Response, error) {
	...
	localVarPath := localBasePath + "/risk-model"
...
func (r ApiRiskModelPutRequest) RiskModel(riskModel RiskModel) ApiRiskModelPutRequest {
	r.riskModel = &riskModel
	return r
}

func (r ApiRiskModelPutRequest) Execute() (*http.Response, error) {
	return r.ApiService.RiskModelPutExecute(r)
}

/*
RiskModelPut Update Risk Model.

Update Risk Model. Deprecated as of 6.5. Please use Conditions instead.
