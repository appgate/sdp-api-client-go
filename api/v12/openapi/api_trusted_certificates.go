...
func (r apiTrustedCertificatesGetRequest) Execute() (TrustedCertificateList, *_nethttp.Response, error) {
	...
	localBasePath, err := r.apiService.client.cfg.ServerURLWithContext(r.ctx, "TrustedCertificatesApiService.TrustedCertificatesGet")
	if err != nil {
...
func (r apiTrustedCertificatesIdGetRequest) Execute() (TrustedCertificate, *_nethttp.Response, error) {
	...
	localBasePath, err := r.apiService.client.cfg.ServerURLWithContext(r.ctx, "TrustedCertificatesApiService.TrustedCertificatesIdGet")
	if err != nil {
		return localVarReturnValue, nil, GenericOpenAPIError{error: err.Error()}
	}
...
func (r apiTrustedCertificatesIdPutRequest) Execute() (TrustedCertificate, *_nethttp.Response, error) {
	...
	localBasePath, err := r.apiService.client.cfg.ServerURLWithContext(r.ctx, "TrustedCertificatesApiService.TrustedCertificatesIdPut")
	if err != nil {
		return localVarReturnValue, nil, GenericOpenAPIError{error: err.Error()}
	}
...
func (r apiTrustedCertificatesPostRequest) Execute() (TrustedCertificate, *_nethttp.Response, error) {
	...
	localBasePath, err := r.apiService.client.cfg.ServerURLWithContext(r.ctx, "TrustedCertificatesApiService.TrustedCertificatesPost")
	if err != nil {
		return localVarReturnValue, nil, GenericOpenAPIError{error: err.Error()}
	}
