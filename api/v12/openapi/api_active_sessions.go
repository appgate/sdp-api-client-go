...
func (r apiSessionInfoDistinguishedNameGetRequest) Execute() (InlineResponse2004, *_nethttp.Response, error) {
	...
	localBasePath, err := r.apiService.client.cfg.ServerURLWithContext(r.ctx, "ActiveSessionsApiService.SessionInfoDistinguishedNameGet")
	if err != nil {
...
func (r apiStatsActiveSessionsGetRequest) Execute() (BaseStats, *_nethttp.Response, error) {
	...
	localBasePath, err := r.apiService.client.cfg.ServerURLWithContext(r.ctx, "ActiveSessionsApiService.StatsActiveSessionsGet")
	if err != nil {
		return localVarReturnValue, nil, GenericOpenAPIError{error: err.Error()}
	}
