...
Download a completed Appliance Backup with the given ID of an Appliance. This API call must be made with **Accept** header of **application/vnd.appgate.peer-v12+gpg** as it returns a GPG file as blob instead of JSON.
  - @param ctx _context.Context - for authentication, logging, cancellation, deadlines, tracing, etc. Passed from http.Request or context.Background().
  - @param id ID of the object.
  - @param backupId The Appliance Backup ID given in the initiation response.
...
*/
func (r apiAppliancesIdBackupBackupIdStatusGetRequest) Execute() (InlineResponse20018, *_nethttp.Response, error) {
	var (
		localVarHTTPMethod   = _nethttp.MethodGet
		localVarPostBody     interface{}
		localVarFormFileName string
...
func (r apiAppliancesIdBackupPostRequest) InlineObject10(inlineObject10 InlineObject10) apiAppliancesIdBackupPostRequest {
...
*/
func (r apiAppliancesIdBackupPostRequest) Execute() (InlineResponse20017, *_nethttp.Response, error) {
	var (
