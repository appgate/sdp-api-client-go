...
func (r apiIdentityProvidersIdAttributesPostRequest) InlineObject4(inlineObject4 InlineObject4) apiIdentityProvidersIdAttributesPostRequest {
...
func (r apiIdentityProvidersIdGetRequest) Execute() (IdentityProvider, *_nethttp.Response, error) {
	...
	localBasePath, err := r.apiService.client.cfg.ServerURLWithContext(r.ctx, "IdentityProvidersApiService.IdentityProvidersIdGet")
	if err != nil {
		return localVarReturnValue, nil, GenericOpenAPIError{error: err.Error()}
	}
