...
func (r apiLdapCertificateIdentityProvidersGetRequest) Execute() (LdapCertificateIdentityProviderList, *_nethttp.Response, error) {
	...
	if localVarHTTPResponse.StatusCode >= 300 {
		...
		if localVarHTTPResponse.StatusCode == 200 {
			var v LdapCertificateIdentityProviderList
...
func (r apiLdapCertificateIdentityProvidersIdAttributesPostRequest) InlineObject4(inlineObject4 InlineObject4) apiLdapCertificateIdentityProvidersIdAttributesPostRequest {
