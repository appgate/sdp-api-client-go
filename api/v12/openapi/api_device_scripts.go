...
func (r apiDeviceScriptsDownloadIdGetRequest) Execute() (InlineResponse20012, *_nethttp.Response, error) {
	...
	localBasePath, err := r.apiService.client.cfg.ServerURLWithContext(r.ctx, "DeviceScriptsApiService.DeviceScriptsDownloadIdGet")
	if err != nil {
...
func (r apiDeviceScriptsGetRequest) Execute() (DeviceScriptList, *_nethttp.Response, error) {
	...
	localBasePath, err := r.apiService.client.cfg.ServerURLWithContext(r.ctx, "DeviceScriptsApiService.DeviceScriptsGet")
	if err != nil {
		return localVarReturnValue, nil, GenericOpenAPIError{error: err.Error()}
	}
...
func (r apiDeviceScriptsIdGetRequest) Execute() (DeviceScript, *_nethttp.Response, error) {
	...
	localBasePath, err := r.apiService.client.cfg.ServerURLWithContext(r.ctx, "DeviceScriptsApiService.DeviceScriptsIdGet")
	if err != nil {
		return localVarReturnValue, nil, GenericOpenAPIError{error: err.Error()}
	}
...
func (r apiDeviceScriptsIdPutRequest) Execute() (DeviceScript, *_nethttp.Response, error) {
	...
	localBasePath, err := r.apiService.client.cfg.ServerURLWithContext(r.ctx, "DeviceScriptsApiService.DeviceScriptsIdPut")
	if err != nil {
		return localVarReturnValue, nil, GenericOpenAPIError{error: err.Error()}
	}
...
func (r apiDeviceScriptsPostRequest) Execute() (DeviceScript, *_nethttp.Response, error) {
	...
	localBasePath, err := r.apiService.client.cfg.ServerURLWithContext(r.ctx, "DeviceScriptsApiService.DeviceScriptsPost")
	if err != nil {
		return localVarReturnValue, nil, GenericOpenAPIError{error: err.Error()}
	}
