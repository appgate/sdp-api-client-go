...
*/
func (r apiAppliancesIdUpgradeGetRequest) Execute() (InlineResponse20016, *_nethttp.Response, error) {
	var (
...
/*
AppliancesIdUpgradeSwitchPartitionPost Switch partition on the Appliance.
