...
func (r ApiTagsPutRequest) Execute() (*Tag, *http.Response, error) {
	return r.ApiService.TagsPutExecute(r)
}

/*
TagsPut Update an existing Tag.
...
//
//	@return Tag
func (a *TagsApiService) TagsPutExecute(r ApiTagsPutRequest) (*Tag, *http.Response, error) {
	var (
