...
const (
	...
	EKS_CLUSTER_TAGS                   ResourceType = "eks-cluster-tags"
	EKS_CLUSTER_TAG_VALUES             ResourceType = "eks-cluster-tag-values"
	RDS_DB_INSTANCES                   ResourceType = "rds-db-instances"
	RDS_DB_INSTANCE_TAGS               ResourceType = "rds-db-instance-tags"
	RDS_DB_INSTANCE_TAG_VALUES         ResourceType = "rds-db-instance-tag-values"
)
...
var AllowedResourceTypeEnumValues = []ResourceType{
	...
	"eks-clusters",
	"eks-cluster-tags",
	"eks-cluster-tag-values",
	"rds-db-instances",
	"rds-db-instance-tags",
	"rds-db-instance-tag-values",
}
