...
// Deprecated
func (o *IssuedCertificateList) GetQuery() string {
...
// and a boolean to check if the value has been set.
// Deprecated
func (o *IssuedCertificateList) GetQueryOk() (*string, bool) {
	if o == nil || o.Query == nil {
		return nil, false
	}
	return o.Query, true
...
func (o *IssuedCertificateList) HasQuery() bool {
	if o != nil && o.Query != nil {
		return true
	}
...
// Deprecated
func (o *IssuedCertificateList) SetQuery(v string) {
	o.Query = &v
}
