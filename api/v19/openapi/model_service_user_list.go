...
// Deprecated
func (o *ServiceUserList) GetQuery() string {
...
// and a boolean to check if the value has been set.
// Deprecated
func (o *ServiceUserList) GetQueryOk() (*string, bool) {
	if o == nil || o.Query == nil {
		return nil, false
	}
	return o.Query, true
...
func (o *ServiceUserList) HasQuery() bool {
	if o != nil && o.Query != nil {
		return true
	}
...
// Deprecated
func (o *ServiceUserList) SetQuery(v string) {
	o.Query = &v
}
