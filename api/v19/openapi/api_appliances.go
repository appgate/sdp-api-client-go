...
Run addressshow command on an Appliance. This API call must be made with **Accept** header of **application/vnd.appgate.com.peer-v19+text** as it returns plain text instead of JSON.
...
Run dig command on an Appliance. This API call must be made with **Accept** header of **application/vnd.appgate.com.peer-v19+text** as it returns plain text instead of JSON.
...
Run ip route show command on an Appliance. This API call must be made with **Accept** header of **application/vnd.appgate.com.peer-v19+text** as it returns plain text instead of JSON.
...
Run netcat command on an Appliance. This API call must be made with **Accept** header of **application/vnd.appgate.com.peer-v19+text** as it returns plain text instead of JSON.
...
Runs ICMP ping command on an Appliance. This API call must be made with **Accept** header of **application/vnd.appgate.peer-v19+text** as it returns plain text instead of JSON.
...
Runs tcpdump command on an Appliance. This API call must be made with **Accept** header of **application/vnd.appgate.peer-v19+text** as it returns plain text instead of JSON.
...
Run traceroute command on an Appliance. This API call must be made with **Accept** header of **application/vnd.appgate.com.peer-v19+text** as it returns plain text instead of JSON.
