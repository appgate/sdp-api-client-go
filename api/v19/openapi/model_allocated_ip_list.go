...
// Deprecated
func (o *AllocatedIpList) GetQuery() string {
...
// and a boolean to check if the value has been set.
// Deprecated
func (o *AllocatedIpList) GetQueryOk() (*string, bool) {
	if o == nil || o.Query == nil {
		return nil, false
	}
	return o.Query, true
...
func (o *AllocatedIpList) HasQuery() bool {
	if o != nil && o.Query != nil {
		return true
	}
...
// Deprecated
func (o *AllocatedIpList) SetQuery(v string) {
	o.Query = &v
}
