...
// Deprecated
func (o *ClientProfileList) GetQuery() string {
...
// and a boolean to check if the value has been set.
// Deprecated
func (o *ClientProfileList) GetQueryOk() (*string, bool) {
	if o == nil || o.Query == nil {
		return nil, false
	}
	return o.Query, true
...
func (o *ClientProfileList) HasQuery() bool {
	if o != nil && o.Query != nil {
		return true
	}
...
// Deprecated
func (o *ClientProfileList) SetQuery(v string) {
	o.Query = &v
}
