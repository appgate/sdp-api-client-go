...
// Deprecated
func (o *ResultListAllOf) GetQuery() string {
...
// and a boolean to check if the value has been set.
// Deprecated
func (o *ResultListAllOf) GetQueryOk() (*string, bool) {
	if o == nil || o.Query == nil {
		return nil, false
	}
	return o.Query, true
...
func (o *ResultListAllOf) HasQuery() bool {
	if o != nil && o.Query != nil {
		return true
	}
...
// Deprecated
func (o *ResultListAllOf) SetQuery(v string) {
	o.Query = &v
}
