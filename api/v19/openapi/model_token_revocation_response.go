...
// Deprecated
func (o *TokenRevocationResponse) GetQuery() string {
...
// and a boolean to check if the value has been set.
// Deprecated
func (o *TokenRevocationResponse) GetQueryOk() (*string, bool) {
	if o == nil || o.Query == nil {
		return nil, false
	}
	return o.Query, true
...
func (o *TokenRevocationResponse) HasQuery() bool {
	if o != nil && o.Query != nil {
		return true
	}
...
// Deprecated
func (o *TokenRevocationResponse) SetQuery(v string) {
	o.Query = &v
}
