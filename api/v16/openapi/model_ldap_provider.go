...
func NewLdapProvider(id string, name string, type_ string, hostnames []string, port int32, adminDistinguishedName string) *LdapProvider {
	this := LdapProvider{}
	this.Id = id
	this.Name = name
	this.Type = type_
...
func (o *LdapProvider) GetClaimMappings() []map[string]interface{} {
...
// and a boolean to check if the value has been set.
func (o *LdapProvider) GetClaimMappingsOk() (*[]map[string]interface{}, bool) {
	if o == nil || o.ClaimMappings == nil {
		return nil, false
	}
...
func (o *LdapProvider) SetClaimMappings(v []map[string]interface{}) {
	o.ClaimMappings = &v
}
...
func (o *LdapProvider) GetOnDemandClaimMappings() []map[string]interface{} {
...
// and a boolean to check if the value has been set.
func (o *LdapProvider) GetOnDemandClaimMappingsOk() (*[]map[string]interface{}, bool) {
	if o == nil || o.OnDemandClaimMappings == nil {
		return nil, false
	}
...
func (o *LdapProvider) SetOnDemandClaimMappings(v []map[string]interface{}) {
