...
// NewDNSClassification instantiates a new DNSClassification object
...
// NewDNSClassificationWithDefaults instantiates a new DNSClassification object
...
func (o *DNSClassification) GetSources() []DNSClassificationAllOfSources {
	if o == nil {
...
func (o *DNSClassification) SetSources(v []DNSClassificationAllOfSources) {
	o.Sources = v
}
...
type NullableDNSClassification struct {
	value *DNSClassification
	isSet bool
}

func (v NullableDNSClassification) Get() *DNSClassification {
	return v.value
}

func (v *NullableDNSClassification) Set(val *DNSClassification) {
	v.value = val
	v.isSet = true
}
...
func NewNullableDNSClassification(val *DNSClassification) *NullableDNSClassification {
	return &NullableDNSClassification{value: val, isSet: true}
}
