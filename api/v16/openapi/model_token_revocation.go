...
func (o *TokenRevocation) GetRevoked() time.Time {
...
// and a boolean to check if the value has been set.
func (o *TokenRevocation) GetRevokedOk() (*time.Time, bool) {
	if o == nil || o.Revoked == nil {
		return nil, false
	}
...
// SetRevoked gets a reference to the given time.Time and assigns it to the Revoked field.
func (o *TokenRevocation) SetRevoked(v time.Time) {
	o.Revoked = &v
}
