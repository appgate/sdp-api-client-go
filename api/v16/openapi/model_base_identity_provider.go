...
func NewBaseIdentityProvider(id string, name string, type_ string) *BaseIdentityProvider {
...
func (o *BaseIdentityProvider) GetClaimMappings() []map[string]interface{} {
...
// and a boolean to check if the value has been set.
func (o *BaseIdentityProvider) GetClaimMappingsOk() (*[]map[string]interface{}, bool) {
	if o == nil || o.ClaimMappings == nil {
		return nil, false
	}
...
func (o *BaseIdentityProvider) SetClaimMappings(v []map[string]interface{}) {
	o.ClaimMappings = &v
}
