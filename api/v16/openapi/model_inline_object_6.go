...
func NewInlineObject6(otp string) *InlineObject6 {
	this := InlineObject6{}
	this.Otp = otp
	return &this
}
...
func (o *InlineObject6) GetOtp() string {
	if o == nil {
		var ret string
		return ret
	}
...
func (o *InlineObject6) GetOtpOk() (*string, bool) {
	if o == nil {
		return nil, false
	}
	return &o.Otp, true
...
func (o *InlineObject6) SetOtp(v string) {
	o.Otp = v
}

// GetState returns the State field value if set, zero value otherwise.
func (o *InlineObject6) GetState() string {
...
// and a boolean to check if the value has been set.
func (o *InlineObject6) GetStateOk() (*string, bool) {
	if o == nil || o.State == nil {
		return nil, false
	}
	return o.State, true
...
func (o *InlineObject6) HasState() bool {
	if o != nil && o.State != nil {
		return true
	}
...
func (o *InlineObject6) SetState(v string) {
	o.State = &v
}
