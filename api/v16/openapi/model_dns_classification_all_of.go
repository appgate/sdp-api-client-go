...
// NewDNSClassificationAllOf instantiates a new DNSClassificationAllOf object
...
func NewDNSClassificationAllOf(sources []DNSClassificationAllOfSources) *DNSClassificationAllOf {
	this := DNSClassificationAllOf{}
	this.Sources = sources
	return &this
}

// NewDNSClassificationAllOfWithDefaults instantiates a new DNSClassificationAllOf object
...
func (o *DNSClassificationAllOf) GetSources() []DNSClassificationAllOfSources {
	if o == nil {
		var ret []DNSClassificationAllOfSources
		return ret
	}
...
func (o *DNSClassificationAllOf) GetSourcesOk() (*[]DNSClassificationAllOfSources, bool) {
	if o == nil {
		return nil, false
	}
...
func (o *DNSClassificationAllOf) SetSources(v []DNSClassificationAllOfSources) {
	o.Sources = v
}
...
type NullableDNSClassificationAllOf struct {
	value *DNSClassificationAllOf
	isSet bool
}

func (v NullableDNSClassificationAllOf) Get() *DNSClassificationAllOf {
	return v.value
}

func (v *NullableDNSClassificationAllOf) Set(val *DNSClassificationAllOf) {
	v.value = val
	v.isSet = true
}

func (v NullableDNSClassificationAllOf) IsSet() bool {
	return v.isSet
}
...
func NewNullableDNSClassificationAllOf(val *DNSClassificationAllOf) *NullableDNSClassificationAllOf {
	return &NullableDNSClassificationAllOf{value: val, isSet: true}
}
