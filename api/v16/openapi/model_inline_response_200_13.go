...
func (o *InlineResponse20013) GetBannerMessage() string {
...
// and a boolean to check if the value has been set.
func (o *InlineResponse20013) GetBannerMessageOk() (*string, bool) {
	if o == nil || o.BannerMessage == nil {
		return nil, false
	}
...
func (o *InlineResponse20013) HasBannerMessage() bool {
	if o != nil && o.BannerMessage != nil {
		return true
	}
...
func (o *InlineResponse20013) SetBannerMessage(v string) {
	o.BannerMessage = &v
}
