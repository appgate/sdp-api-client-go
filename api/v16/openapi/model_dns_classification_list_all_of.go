...
// NewDNSClassificationListAllOf instantiates a new DNSClassificationListAllOf object
// This constructor will assign default values to properties that have it defined,
// and makes sure properties required by API are set, but the set of arguments
// will change when the set of required properties is changed
func NewDNSClassificationListAllOf() *DNSClassificationListAllOf {
	this := DNSClassificationListAllOf{}
	return &this
}

// NewDNSClassificationListAllOfWithDefaults instantiates a new DNSClassificationListAllOf object
...
func (o *DNSClassificationListAllOf) GetData() []DNSClassification {
	if o == nil || o.Data == nil {
		var ret []DNSClassification
		return ret
	}
	return *o.Data
}
...
func (o *DNSClassificationListAllOf) SetData(v []DNSClassification) {
	o.Data = &v
}
...
type NullableDNSClassificationListAllOf struct {
	value *DNSClassificationListAllOf
	isSet bool
}

func (v NullableDNSClassificationListAllOf) Get() *DNSClassificationListAllOf {
	return v.value
}

func (v *NullableDNSClassificationListAllOf) Set(val *DNSClassificationListAllOf) {
	v.value = val
	v.isSet = true
}

func (v NullableDNSClassificationListAllOf) IsSet() bool {
	return v.isSet
}

func (v *NullableDNSClassificationListAllOf) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableDNSClassificationListAllOf(val *DNSClassificationListAllOf) *NullableDNSClassificationListAllOf {
	return &NullableDNSClassificationListAllOf{value: val, isSet: true}
}
