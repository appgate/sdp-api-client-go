...
// NewLocalDatabaseProviderAllOf instantiates a new LocalDatabaseProviderAllOf object
// This constructor will assign default values to properties that have it defined,
// and makes sure properties required by API are set, but the set of arguments
// will change when the set of required properties is changed
func NewLocalDatabaseProviderAllOf() *LocalDatabaseProviderAllOf {
	this := LocalDatabaseProviderAllOf{}
...
// NewLocalDatabaseProviderAllOfWithDefaults instantiates a new LocalDatabaseProviderAllOf object
...
type NullableLocalDatabaseProviderAllOf struct {
	value *LocalDatabaseProviderAllOf
	isSet bool
}

func (v NullableLocalDatabaseProviderAllOf) Get() *LocalDatabaseProviderAllOf {
	return v.value
}

func (v *NullableLocalDatabaseProviderAllOf) Set(val *LocalDatabaseProviderAllOf) {
	v.value = val
	v.isSet = true
}

func (v NullableLocalDatabaseProviderAllOf) IsSet() bool {
	return v.isSet
}

func (v *NullableLocalDatabaseProviderAllOf) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableLocalDatabaseProviderAllOf(val *LocalDatabaseProviderAllOf) *NullableLocalDatabaseProviderAllOf {
	return &NullableLocalDatabaseProviderAllOf{value: val, isSet: true}
}
