...
func (r ApiStatsFailedAuthenticationsGetRequest) Execute() (FailedAuthentications, *_nethttp.Response, error) {
	return r.ApiService.StatsFailedAuthenticationsGetExecute(r)
}
...
func (a *FailedAuthenticationsPerHourApiService) StatsFailedAuthenticationsGetExecute(r ApiStatsFailedAuthenticationsGetRequest) (FailedAuthentications, *_nethttp.Response, error) {
	var (
		...
		localVarReturnValue  FailedAuthentications
	)

	localBasePath, err := a.client.cfg.ServerURLWithContext(r.ctx, "FailedAuthenticationsPerHourApiService.StatsFailedAuthenticationsGet")
	if err != nil {
		return localVarReturnValue, nil, GenericOpenAPIError{error: err.Error()}
	}

	localVarPath := localBasePath + "/stats/failed-authentications"
