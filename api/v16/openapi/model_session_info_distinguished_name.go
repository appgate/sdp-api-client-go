...
type SessionInfoDistinguishedName struct {
	...
	Data *map[string]SessionInfoDistinguishedNameData `json:"data,omitempty"`
}
...
func (o *SessionInfoDistinguishedName) GetData() map[string]SessionInfoDistinguishedNameData {
	if o == nil || o.Data == nil {
		var ret map[string]SessionInfoDistinguishedNameData
		return ret
	}
	return *o.Data
}
...
// and a boolean to check if the value has been set.
func (o *SessionInfoDistinguishedName) GetDataOk() (*map[string]SessionInfoDistinguishedNameData, bool) {
	if o == nil || o.Data == nil {
		return nil, false
	}
	return o.Data, true
...
// SetData gets a reference to the given map[string]SessionInfoDistinguishedNameData and assigns it to the Data field.
func (o *SessionInfoDistinguishedName) SetData(v map[string]SessionInfoDistinguishedNameData) {
	o.Data = &v
}
