...
// NewDnsRuleListAllOf instantiates a new DnsRuleListAllOf object
// This constructor will assign default values to properties that have it defined,
// and makes sure properties required by API are set, but the set of arguments
// will change when the set of required properties is changed
func NewDnsRuleListAllOf() *DnsRuleListAllOf {
	this := DnsRuleListAllOf{}
	return &this
}

// NewDnsRuleListAllOfWithDefaults instantiates a new DnsRuleListAllOf object
...
type NullableDnsRuleListAllOf struct {
	value *DnsRuleListAllOf
	isSet bool
}

func (v NullableDnsRuleListAllOf) Get() *DnsRuleListAllOf {
	return v.value
}

func (v *NullableDnsRuleListAllOf) Set(val *DnsRuleListAllOf) {
	v.value = val
	v.isSet = true
}
...
func NewNullableDnsRuleListAllOf(val *DnsRuleListAllOf) *NullableDnsRuleListAllOf {
	return &NullableDnsRuleListAllOf{value: val, isSet: true}
}
