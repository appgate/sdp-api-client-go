...
// NewDNSClassificationList instantiates a new DNSClassificationList object
// This constructor will assign default values to properties that have it defined,
// and makes sure properties required by API are set, but the set of arguments
// will change when the set of required properties is changed
func NewDNSClassificationList() *DNSClassificationList {
	this := DNSClassificationList{}
	return &this
}

// NewDNSClassificationListWithDefaults instantiates a new DNSClassificationList object
...
func (o *DNSClassificationList) GetData() []DNSClassification {
	if o == nil || o.Data == nil {
...
type NullableDNSClassificationList struct {
	value *DNSClassificationList
	isSet bool
}

func (v NullableDNSClassificationList) Get() *DNSClassificationList {
	return v.value
}

func (v *NullableDNSClassificationList) Set(val *DNSClassificationList) {
	v.value = val
	v.isSet = true
}

func (v NullableDNSClassificationList) IsSet() bool {
	return v.isSet
}
...
func NewNullableDNSClassificationList(val *DNSClassificationList) *NullableDNSClassificationList {
	return &NullableDNSClassificationList{value: val, isSet: true}
}
