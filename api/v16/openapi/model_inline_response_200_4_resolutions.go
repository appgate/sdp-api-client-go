...
// NewInlineResponse2004Resolutions instantiates a new InlineResponse2004Resolutions object
// This constructor will assign default values to properties that have it defined,
// and makes sure properties required by API are set, but the set of arguments
// will change when the set of required properties is changed
func NewInlineResponse2004Resolutions() *InlineResponse2004Resolutions {
	this := InlineResponse2004Resolutions{}
	return &this
}

// NewInlineResponse2004ResolutionsWithDefaults instantiates a new InlineResponse2004Resolutions object
...
type NullableInlineResponse2004Resolutions struct {
	value *InlineResponse2004Resolutions
	isSet bool
}

func (v NullableInlineResponse2004Resolutions) Get() *InlineResponse2004Resolutions {
	return v.value
}

func (v *NullableInlineResponse2004Resolutions) Set(val *InlineResponse2004Resolutions) {
	v.value = val
	v.isSet = true
}

func (v NullableInlineResponse2004Resolutions) IsSet() bool {
	return v.isSet
}

func (v *NullableInlineResponse2004Resolutions) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableInlineResponse2004Resolutions(val *InlineResponse2004Resolutions) *NullableInlineResponse2004Resolutions {
	return &NullableInlineResponse2004Resolutions{value: val, isSet: true}
}
