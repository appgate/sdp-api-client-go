...
func (o *LocalDatabaseProvider) GetClaimMappings() []map[string]interface{} {
...
// and a boolean to check if the value has been set.
func (o *LocalDatabaseProvider) GetClaimMappingsOk() (*[]map[string]interface{}, bool) {
	if o == nil || o.ClaimMappings == nil {
		return nil, false
	}
...
func (o *LocalDatabaseProvider) SetClaimMappings(v []map[string]interface{}) {
	o.ClaimMappings = &v
}
...
func (o *LocalDatabaseProvider) GetOnDemandClaimMappings() []map[string]interface{} {
...
// and a boolean to check if the value has been set.
func (o *LocalDatabaseProvider) GetOnDemandClaimMappingsOk() (*[]map[string]interface{}, bool) {
	if o == nil || o.OnDemandClaimMappings == nil {
		return nil, false
	}
...
func (o *LocalDatabaseProvider) SetOnDemandClaimMappings(v []map[string]interface{}) {
