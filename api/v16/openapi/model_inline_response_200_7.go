...
func (o *InlineResponse2007) GetSecret() string {
...
// and a boolean to check if the value has been set.
func (o *InlineResponse2007) GetSecretOk() (*string, bool) {
	if o == nil || o.Secret == nil {
		return nil, false
	}
...
func (o *InlineResponse2007) HasSecret() bool {
	if o != nil && o.Secret != nil {
		return true
	}
...
func (o *InlineResponse2007) SetSecret(v string) {
	o.Secret = &v
}

// GetOtpAuthUrl returns the OtpAuthUrl field value if set, zero value otherwise.
func (o *InlineResponse2007) GetOtpAuthUrl() string {
...
// and a boolean to check if the value has been set.
func (o *InlineResponse2007) GetOtpAuthUrlOk() (*string, bool) {
	if o == nil || o.OtpAuthUrl == nil {
		return nil, false
	}
...
func (o *InlineResponse2007) HasOtpAuthUrl() bool {
	if o != nil && o.OtpAuthUrl != nil {
		return true
	}
...
func (o *InlineResponse2007) SetOtpAuthUrl(v string) {
	o.OtpAuthUrl = &v
}

// GetBarcode returns the Barcode field value if set, zero value otherwise.
func (o *InlineResponse2007) GetBarcode() string {
...
// and a boolean to check if the value has been set.
func (o *InlineResponse2007) GetBarcodeOk() (*string, bool) {
	if o == nil || o.Barcode == nil {
		return nil, false
	}
...
func (o *InlineResponse2007) HasBarcode() bool {
	if o != nil && o.Barcode != nil {
		return true
	}
...
func (o *InlineResponse2007) SetBarcode(v string) {
	o.Barcode = &v
}

// GetResponseMessage returns the ResponseMessage field value if set, zero value otherwise.
func (o *InlineResponse2007) GetResponseMessage() string {
...
// and a boolean to check if the value has been set.
func (o *InlineResponse2007) GetResponseMessageOk() (*string, bool) {
	if o == nil || o.ResponseMessage == nil {
		return nil, false
	}
...
func (o *InlineResponse2007) HasResponseMessage() bool {
	if o != nil && o.ResponseMessage != nil {
		return true
	}
...
func (o *InlineResponse2007) SetResponseMessage(v string) {
	o.ResponseMessage = &v
}
...
func (o *InlineResponse2007) GetTimeout() float32 {
...
// and a boolean to check if the value has been set.
func (o *InlineResponse2007) GetTimeoutOk() (*float32, bool) {
	if o == nil || o.Timeout == nil {
		return nil, false
	}
...
func (o *InlineResponse2007) HasTimeout() bool {
	if o != nil && o.Timeout != nil {
		return true
	}
...
func (o *InlineResponse2007) SetTimeout(v float32) {
	o.Timeout = &v
}

// GetSendPassword returns the SendPassword field value if set, zero value otherwise.
func (o *InlineResponse2007) GetSendPassword() bool {
...
// and a boolean to check if the value has been set.
func (o *InlineResponse2007) GetSendPasswordOk() (*bool, bool) {
	if o == nil || o.SendPassword == nil {
		return nil, false
	}
...
func (o *InlineResponse2007) HasSendPassword() bool {
	if o != nil && o.SendPassword != nil {
		return true
	}
...
func (o *InlineResponse2007) SetSendPassword(v bool) {
	o.SendPassword = &v
}
