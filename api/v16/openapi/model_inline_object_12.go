...
func NewInlineObject12(url string, filename string) *InlineObject12 {
	this := InlineObject12{}
	this.Url = url
...
func (o *InlineObject12) GetUrl() string {
	if o == nil {
		var ret string
		return ret
	}
...
func (o *InlineObject12) GetUrlOk() (*string, bool) {
	if o == nil {
		return nil, false
	}
	return &o.Url, true
...
func (o *InlineObject12) SetUrl(v string) {
	o.Url = v
}

// GetFilename returns the Filename field value
func (o *InlineObject12) GetFilename() string {
	if o == nil {
		var ret string
		return ret
	}
...
// and a boolean to check if the value has been set.
func (o *InlineObject12) GetFilenameOk() (*string, bool) {
	if o == nil {
		return nil, false
	}
...
func (o *InlineObject12) SetFilename(v string) {
	o.Filename = v
}
